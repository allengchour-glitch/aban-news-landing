...
## Branchen-Hubs (`ki-fuer-*.html`) — Stand: **310 live, alle viersprachig (de/en/fr/it ≈ 1240 Seiten)** 🎉 300+ (Parallel-Session zählt Stand evtl. anders)
...
- Welle 76 (gebrauchtwarenhandel, schokoladenmanufaktur, spieleladen): nach Container-Reclaim **neu gestartet** (Agenten laufen) — Slugs frei.
