...
## Branchen-Hubs (`ki-fuer-*.html`) — Stand: **131 live, alle viersprachig (de/en/fr/it = 524 Seiten)**
...
- Welle 21 (128→131): Entkernung, Fassadenbau, Blitzschutz — **direkt viersprachig** (Entkernung mit Schadstoff-/Asbest-Grenze, Blitzschutz mit Auslegungs-/Prüf-Grenze).
