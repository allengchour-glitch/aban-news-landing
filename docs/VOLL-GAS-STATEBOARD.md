...
- **Welle 89–90 (6 Hubs, „max agenten" #6, 334→340):** Imbiss, Spirituosenhandel, Bowlingcenter, Hochzeitsplaner, Tierbestattung, Seniorenbetreuung — **direkt viersprachig**, 6 Agenten gleichzeitig. (Imbiss LMIV/Allergene/HACCP, distinkt von restaurants/pizzeria; Spirituosenhandel Jugendschutz ab 18 + Alkoholwerbe-Beschränkung, distinkt von getraenkemarkt/weinhandlung; Bowlingcenter Betrieb/Sicherheit/Aufsicht + Gastro-Hygiene; Hochzeitsplaner SEHR persönlich — kein Beratungs-/Koordinations-Ersatz am Tag, keine Dienstleister-Prüfung/Verträge, distinkt von eventplaner/eventlocation; Tierbestattung PIETÄT — kein Beistand-/Trauerbegleitungs-Ersatz, Tierkörperbeseitigungs-Recht, sehr sensible Halterdaten; Seniorenbetreuung NICHT-medizinisch — keine Pflege-/Gesundheitsauskünfte [an Pflegedienst/Arzt verweisen], distinkt von pflegedienste.) seniorenbetreuung-Agent crashte bei it/ (API socket) → Recovery-Agent nur für die fehlende IT-Datei.
