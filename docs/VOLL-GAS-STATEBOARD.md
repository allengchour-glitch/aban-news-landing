...
## Branchen-Hubs (`ki-fuer-*.html`) — Stand: **149 live, alle viersprachig (de/en/fr/it = 596 Seiten)**
...
- Welle 27 (146→149): Glasreinigung, Winterdienst, Graffitientfernung — **direkt viersprachig** (Winterdienst mit Haftungs-/Verkehrssicherungspflicht-Grenze, Glasreinigung mit Höhenarbeits-Grenze).
