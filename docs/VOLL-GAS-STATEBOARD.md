...
## Branchen-Hubs (`ki-fuer-*.html`) — Stand: **233 live, alle viersprachig (de/en/fr/it = 932 Seiten)**
...
- Welle 55 (230→233): Holzbildhauer, Seifenmanufaktur, Kerzenmanufaktur — **direkt viersprachig** (Holzbildhauer Restaurierungs-/Echtheits-/KI-Entwurf-Rechte-Grenze, Seifenmanufaktur NaOH-Verseifung-/EU-Kosmetik-VO-/Health-Claims-Grenze, Kerzenmanufaktur EN-15493-Sicherheitsnorm-/CLP-/Health-Claims-Grenze).
