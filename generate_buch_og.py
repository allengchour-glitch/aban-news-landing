"""
aban news — OG-Image-Generator für die Buch-Verkaufsseite (1200×630, Pillow).

Erzeugt das Open-Graph-Bild für buch.html → og-buch.png.
Stil identisch zu og-ebook.png (siehe generate_og_images.py): gleicher
Font-Loader, gleiche Brand-Farben, gleiche Amber-Akzent-Formen.

Run:  python3 generate_buch_og.py
...
def make(out, badge, title, subs, foot, title_size=118):
    """Layout 1:1 wie generate_og_images.make() — gleicher Look wie og-ebook.png."""
    W, H = 1200, 630
...
def build():
    make(
        ...
        "DAS BUCH · PWYW",
        "Anti-Hype",
        ["Wie Solopreneure KI", "ohne Bullshit einsetzen"],
        "PDF · ePub · Kindle  ·  abannews.com",
        title_size=118,
    )
