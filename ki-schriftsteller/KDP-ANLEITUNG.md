# KDP-Metadaten & Anleitung — „Das Tal hält den Atem an"
...
2. **Sprache:** Deutsch · **Titel:** Das Tal hält den Atem an · **Untertitel:** Ein Generationendrama in drei Bänden
3. **Verfasser:** aban news
...
**Titel:** Das Tal hält den Atem an
