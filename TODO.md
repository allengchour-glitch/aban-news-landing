...
## 🔥 Zuerst — REICHWEITE restaurieren (Traffic auf 7–12/Tag abgestürzt = Hauptproblem)
- [x] ~~Testkauf + TWINT~~ ✅ **erledigt — ging komplett durch, Bezahlung funktioniert**
- [ ] **1. 💻 `wrangler deploy`** (Worker `luxe-poster`) → Organik-Posting hoch (Queue 141 Posts wartet) + Handy-Steuerung + Auto-Reply
- [ ] **2. 🔴 TikTok Pixel + 1 CH-Kampagne + Budget** → [TikTok Ads](https://ads.tiktok.com/) *(Pixel D8EKVR…, CH/Frauen/18–34, Complete Payment, 20 CHF/Tag)* — der bezahlte Reichweite-Hebel

## 📣 Dann — mehr kostenlose Reichweite
- [ ] **3. 🔴 Google Free Listings AN** → [Merchant Center](https://merchants.google.com/) → Wachstum → Listings *(search = nur 4 Sessions/14T → reine Upside, Konto entsperrt)*
- [ ] **4. 🔴 Klaviyo URL→`.ch` + Währung→CHF** → [Klaviyo Konto](https://www.klaviyo.com/settings/account)
