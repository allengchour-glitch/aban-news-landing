...
- 2026-09-24 · 📦 **Fortura ohne EK (4'040) → `fortura_ek_nachtragen.py` (VP1×VE+DPD, ×1.081, Shop nicht MWST-pflichtig), 4'036 live; Importer rechneten Bündel mit Stückpreis (Rosen 72 Stk für 16.90 bei 68.40 EK) → ×VE + cost beim Anlegen; DENY+Bestand ist keine Sperre → DRAFT oder Boden.** Stückpreis ≠ Angebotspreis → Journal Nachtrag 69
- 2026-09-24 · 💰 **«nie verlust» (Entscheid: Codes bleiben, Preise decken 25 %): `preis_verlustschutz.py` hebt jeden Preis auf den Boden für 25 % Code + Gratisversand (.90, nur heben, >2× → DENY); 22'609 Produkte / 224'299 Varianten, Aufseher-Lauf; 128'446 Varianten ohne EK (Fortura) unbekannt.** Skript und Starter nie dieselbe Sperrdatei → Journal Nachtrag 68
- 2026-09-24 · 🛠️ **«fix und verbessere writer»: Varianten-Schreiber vererbte keinen EK (Kanarienvogel 13/14, Stecker 54/69 → nachgetragen, rückgelesen); Prüfer-Workflow 22 Befunde → Abbruch beim 1. Fehler, Rückbau per productOptionsDelete POSITION (an Wegwerf-Entwurf getestet), sonst DENY; Mischwerte über Wortschatz («Eckig · M»).** Versuche zählen, nicht Erfolge; neue Varianten Feld für Feld gegen die Ursprungsvariante prüfen → Journal Nachtrag 67
...
… Einzeilen vom 14.–22.09.2026 (128, zwanzig vom 21.09., dreiundzwanzig vom 22.09.) am 23.09. und zweiunddreissig vom 23.09. am 24./25.09. sowie die ältesten vom 24.09. am 26.09. VERBATIM ins Journal verschoben (Abschnitt «📚 Index-Archiv» am
