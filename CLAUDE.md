...
- 2026-09-22 · 🩺 **Heilversprechen: 95 Zusagen in 51'341 Produkten entschärft — und der Fund vom 04.09. war durch einen Rückholer zurückgekommen.** Kein Wächter für die Klasse → `heilversprechen_wache.py` (täglich, Ersatztabelle, Bericht); `um()` machte «denen Sie» zu «denst du»; 831 CJ-Produkte mit einem Bild → `cj_bild_nachtrag.py` (Produktcode-SKUs brauchen `productSku=`). **Fix = Wächter + Tabelle + Bericht, sonst ist es keiner** → Journal
