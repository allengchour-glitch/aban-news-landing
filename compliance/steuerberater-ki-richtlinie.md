# KI-Nutzungsrichtlinie — Vorlage für Steuerberater:innen

> Diese Vorlagen sind ein anpassbarer Startpunkt und **keine Rechts-, Steuer- oder Datenschutzberatung**. Vor dem Einsatz fachkundig bzw. juristisch prüfen und an die eigene Kanzlei/Praxis anpassen. Stand der Regelwerke laufend selbst verifizieren.

## 1. Zweck
Diese Richtlinie regelt den Einsatz von KI-Tools in unserer Steuerkanzleie.
...
## 3. Niemals eingeben
- Mandantendaten (steuerliches Berufsgeheimnis)
...
## 6. Berufsrecht
- Verschwiegenheitspflicht (§ 57 StBerG, § 203 StGB) hat Vorrang. Im Zweifel: kein KI-Einsatz mit Mandanten-/Patientenbezug.
