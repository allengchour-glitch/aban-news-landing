#!/usr/bin/env python3
"""Lifestyle-Radar — static site generator (German, DACH-Fokus).

Reads the curated KI-lifestyle-app database (data/anbieter.json) and an
...
du-Form — Lifestyle-KI ist hype-lastig, hier wird ehrlich verglichen.
...
SITE_NAME = "Lifestyle-Radar"
BASE_URL = "https://lifestyle.abannews.com"
LANG = "de"
...
UI = {
    "tagline": "KI-Apps für Alltag & Lifestyle (Fitness, Ernährung, Reise, Sprache, Geld, Zuhause), ehrlich verglichen — mit Datenschutz-Blick",
    "all_tools": "← Alle Apps",
    "categories": "Kategorien",
    "focuses": "Schwerpunkt",
    "home_heading": "{n} KI-Lifestyle-Apps im Überblick",
    "provider": "Anbieter",
    "type": "Typ",
    "focus": "Schwerpunkt",
    "language": "Sprache",
    ...
    "best_in": "Beste KI-Lifestyle-Apps: {cat}",
    "focus_page": "KI-Lifestyle-Apps: {foc}",
    "privacy": "Datenschutz",
    "imprint": "Impressum",
    ...
    "search_ph": "App, Anbieter oder Funktion suchen…",
    ...
    "honest": ("Ehrlich vorab: Lifestyle-KI-Apps versprechen oft mehr, als sie halten — "
               "ein Coach-Chatbot ersetzt keine Ärztin, keinen Trainer und keine Steuerberatung. "
               "Wichtiger noch: Diese Apps verarbeiten oft sehr persönliche Daten "
               "(Gesundheit, Ernährung, Standort, Finanzen). Wo die Daten liegen, wer sie sieht "
               "und was in den AGB steht, musst du selbst prüfen. Dieser Radar vergleicht Apps "
               "nüchtern — er verspricht kein besseres Leben per Klick."),
    "meta_home": ("{n} KI-Apps für Alltag & Lifestyle im Vergleich: "
                  "Fitness, Ernährung, Reise, Sprachenlernen, private Finanzen, Zuhause — "
                  "ehrlich, mit Datenschutz-Blick, ohne Hype."),
    "meta_tool": "{name} ({anbieter}): Typ, Schwerpunkt, Integrationen, EU-Hosting und offizieller Link.",
    "meta_cat": "Die besten KI-Lifestyle-Apps im Bereich {cat} — ehrlich verglichen für DACH.",
    "meta_foc": "KI-Lifestyle-Apps mit Schwerpunkt {foc} — Funktionen und offizielle Links im Vergleich.",
}
...
FAVICON_SVG = (
    ...
    '<path d="M26 20l18 12-18 12z" fill="#fff"/></svg>'
)
...
def faq_section(tool):
    ...
    # Deutsche Oberfläche / Stimmen (DACH-relevant)
    qa.append((f"Versteht {name} Deutsch und hat es eine deutsche Oberfläche?",
               {"ja": f"Ja, {name} bietet laut Anbieter eine deutschsprachige Oberfläche bzw. deutsche Stimmen/Untertitel.",
                "nein": f"Nein, {name} ist primär englischsprachig — deutsche Inhalte/Stimmen vor dem Einsatz testweise prüfen.",
    ...
    qa.append((f"Hostet {name} in der EU (DSGVO-relevant)?",
               {"ja": "Ja, laut Anbieter gibt es EU-Hosting bzw. EU-Datenverarbeitung — das erleichtert die DSGVO-Konformität, gerade bei persönlichen Daten (Gesundheit, Standort, Finanzen).",
                "nein": "Nein, die Datenverarbeitung erfolgt überwiegend außerhalb der EU — Auftragsverarbeitung (AVV) und Drittlandtransfer (z. B. Standardvertragsklauseln) selbst prüfen, bevor du persönliche Daten (Gesundheit, Standort, Finanzen) eingibst.",
...
def home_page(tools, categories, focuses, aff):
    ...
    body = (f'{site_schema()}{itemlist(tools)}'
            ...
            f'„{e(UI["eu_stock"])}“ ist der wichtigste DACH-Filter: DSGVO-näher, EU-Datenverarbeitung, weniger Drittland-Aufwand bei persönlichen Daten (Gesundheit, Standort, Finanzen).</p>\n'
...
LEGAL_DOMAIN = "lifestyle.abannews.com"
...
<p>Dieser Radar vergleicht Apps und ersetzt keine Rechts-, Gesundheits-, Finanz- oder Datenschutzberatung. Pflichten
beim Einsatz von KI-Lifestyle-Apps (z. B. Umgang mit Gesundheits-/Finanzdaten,
Auftragsverarbeitung nach Art. 28 DSGVO, ggf. Drittlandtransfer) liegen bei dir.</p>
...
<h2>6. Hinweis zu deinen Daten bei den verglichenen Apps</h2>
<p>Die hier verglichenen KI-Lifestyle-Apps laufen bei den jeweiligen Anbietern,
nicht auf dieser Website. Gibst du dort persönliche Daten ein (z. B. Gesundheit, Ernährung, Standort, Finanzen), verarbeitest du
womöglich besonders sensible Daten. Hosting-Standort, Auftragsverarbeitung (AVV) und
ggf. Drittlandtransfer klärst du direkt mit dem Anbieter — diese Website ist daran nicht beteiligt.</p>
<h2>7. Newsletter</h2>
...
def notfound_page():
    body = (f'<h1>🌿 404 — Seite nicht gefunden</h1>\n'
            f'<p class="meta">Diese Seite gibt es nicht. Zurück zur Übersicht aller KI-Lifestyle-Apps.</p>\n'
...
SEARCH_JS = """// Lifestyle-Radar — client-side filter (no deps, no tracking)
(function () {
...
def main():
    ...
    ap = argparse.ArgumentParser(description="Lifestyle-Radar generator")
