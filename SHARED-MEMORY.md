...
- **📜 „VIEL SCROLLEN" auf Kollektions-Seiten (User 2026-06-16) — FÜR THEME- + TAXONOMIE-SESSION:** Mehrere Kollektionen sind riesig
  ...
  **Verbleibender echter Scroll-Hebel = THEME products/page (~24) + Storefront-Filter** (für wenn jemand DOCH auf einer grossen Kollektion landet). **🧸 Die 6 Spielzeug-Subs (Puzzles/Plüsch/Figuren/Brettspiele/Puppen/Kostüme) sind NEU und noch NICHT im Menü** → bitte unter dem „Spielzeug"-Menüpunkt als Sub-Items ergänzen (Theme/Taxonomie-Session).
