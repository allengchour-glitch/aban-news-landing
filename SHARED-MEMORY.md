...
- **Lehre/Architektur:** Engpass für unbeaufsichtigte Autonomie = **Shopify-Token** (App-Install ODER `SHOPIFY_ADMIN_TOKEN`-Secret). Alles ist gebaut + no-op-sicher; ein User-Klick (App-Install) schaltet Bestseller-Cron + Shop-Wartung + Gelato vollautonom frei. Reichweite bleibt separat (§10).
