...
> **🐞 PAGE-FIX (User-Screenshot „unten kein Bild"):** Auf `/pages/selbst-gestalten` hatte die Karte „Baby-Jersey-Body" eine tote CDN-URL (`baby-jersey-bodysuit-white-front-…` = HTTP 404) → auf das echte READY-Produktbild getauscht (+ Subagent scannt alle Karten-Bilder auf weitere 404). Produkt selbst hatte gültiges Bild; nur die Page-Card-URL war tot.
