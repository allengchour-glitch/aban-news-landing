...
- **📜 „VIEL SCROLLEN" auf Kollektions-Seiten (User 2026-06-16) — FÜR THEME- + TAXONOMIE-SESSION:** Mehrere Kollektionen sind riesig
  ...
  **BEFUND Damen-Mode (622):** ist ein **Sammelbecken** (Tag damen OR kleid OR damen-taschen OR sandalen) — überlappt mit allen Spezial-Kollektionen (Schmuck/Uhren/Parfum/Taschen 189/Schuhe 165/Kleider 46…); echte Damen-**Bekleidung** ist winzig (Tops 4/Hosen 1/Hoodies 2). → Splitten löst Scroll NICHT. **Echter Fix: (a) Theme products/page+Filter, (b) MENÜ direkt auf die kleineren Spezial-Kollektionen routen statt auf den 622-Catch-all.** 3 Bekleidungs-Subs trotzdem angelegt+publiziert (sub-tops-blusen/sub-hosen/sub-hoodies, wachsen mit Importen).
