...
0. 🎯 **PIXEL FEUERT NICHT = HÖCHSTE PRIO „egal wie" (User 2026-06-22):** TikTok-Pixel `D8EKVR3C77U6KT5BTBD0` ist eingebaut, aber **consent-gesperrt** (Cookie-Banner) → daten-leer. **FIX:** Admin → Einstellungen → **Kundendatenschutz/Cookie-Banner** → da Shop **CH-only (nicht EU/GDPR)** Tracking **ohne Opt-in-Pflicht** zulassen / Consent-Default = akzeptiert → Pixel feuert. (Consent-Mode = Theme/Settings, nicht per Admin-API flippbar.)
