...
(function () {
  ...
  try {
    ...
    var NAV = [
      ...
      ["🤖 KI-Automation", "/ki-automation.html"],
    ...
    var CAT = [
      ...
      ["Digitaler Shop", "/shop.html", "Leistungen", "KI-Prompt-Packs & Compliance-Vorlagen kaufen (CH/DACH)"],
      ["100 KI-Profi-Prompts", "/ki-profi-prompts.html", "Leistungen", "Fertige KI-Prompts für DACH-KMU — CHF 29.—"],
      ["KI-Compliance Paket Schweiz", "/ki-compliance-paket.html", "Leistungen", "KI-Richtlinie + DSGVO-Checkliste + EU AI Act — CHF 49.—"],
      ["KI-Beratung für KMU (Schweiz)", "/ki-beratung.html", "Leistungen", "Erstgespräch gratis — KI-Strategie für Schweizer Betriebe"],
      ["Freelancer Steuer-Checkliste Schweiz", "/freelancer-steuern-checkliste.html", "Leistungen", "AHV, MWST, Rücklagen & Fristen — Download CHF 19"],
      ...
      ["Impressum Vorlage Schweiz", "/impressum-vorlage-schweiz.html", "Leistungen", "OR Art. 3 UWG + DSG-konforme Impressumsvorlage für Websites & KMU — Download CHF 19"],
      ["NDA Vorlage Schweiz", "/nda-vorlage-schweiz.html", "Leistungen", "Geheimhaltungsvereinbarung CH: einseitig, gegenseitig, Freelancer — Download CHF 29"],
      ["GmbH Statuten Vorlage Schweiz", "/gmbh-statuten-vorlage-schweiz.html", "Leistungen", "OR-konforme Musterstatuten + Gesellschaftsvertrag für Schweizer GmbH — Download CHF 79"],
      ["Vollmacht Vorlage Schweiz", "/vollmacht-vorlage-schweiz.html", "Leistungen", "OR Art. 32–40 Vollmacht: allgemein, Vorsorge, Spezial, Bank — Download CHF 19"],
      ["Kündigung Vorlage Schweiz", "/kuendigung-vorlage-schweiz.html", "Leistungen", "Miet, Arbeit, Krankenkasse, Abo — OR-konforme Vorlagen Download CHF 19"],
      ["Mietvertrag Vorlage Schweiz", "/mietvertrag-vorlage-schweiz.html", "Leistungen", "OR Art. 253–274 Mietvertragsvorlage + Übergabeprotokoll — Download CHF 39"],
      ["AHV-Rechner Freelancer Schweiz", "/ahv-rechner-freelancer.html", "Business", "AHV/IV/EO-Beiträge 2025 kostenlos berechnen (10.1%)"],
      ["Nettolohn Rechner Schweiz", "/nettolohn-rechner-schweiz.html", "Business", "Brutto-Netto 2025 berechnen: AHV, BVG, Quellensteuer (kostenlos)"],
      ["Pensum Rechner Schweiz", "/pensum-rechner-schweiz.html", "Business", "Teilzeit-Lohn, Stunden & Ferien berechnen — 100% bis 20% Pensum (kostenlos)"],
      ["Hypothek Rechner Schweiz", "/hypothek-rechner-schweiz.html", "Business", "Hypothek, Tragbarkeit & Amortisation berechnen (1./2. Hypothek, SARON) — kostenlos"],
      ...
      ["Elektroauto kaufen Schweiz", "/elektroauto-kaufen-schweiz.html", "Start", "BEV-Ratgeber: Reichweite, Förderung & Ladenetz (CH)"],
      ["Klimaanlage kaufen Schweiz", "/klimaanlage-kaufen-schweiz.html", "Start", "Split vs. mobil, Installation & F-Gase (CH)"],
      ["Induktionskochfeld kaufen Schweiz", "/induktionskochfeld-kaufen-schweiz.html", "Start", "Watt, Töpfe & Einbau erklärt (CH)"],
      ["Gefrierschrank kaufen Schweiz", "/gefrierschrank-kaufen-schweiz.html", "Start", "NoFrost, Energieklasse A & Grösse (CH)"],
      ["Fahrrad kaufen Schweiz", "/fahrrad-kaufen-schweiz.html", "Start", "Velo, MTB, Rennrad & Rahmengrösse (CH)"],
      ["Velomotor kaufen Schweiz", "/velomotor-kaufen-schweiz.html", "Start", "Motorroller 125 ccm, Führerausweis & Versicherung (CH)"],
      ["Wärmepumpe kaufen Schweiz", "/waermepumpe-kaufen-schweiz.html", "Start", "Luft-Wasser, Erdwärme & Kosten (CH)"],
      ["Balkonkraftwerk kaufen Schweiz", "/balkonkraftwerk-kaufen-schweiz.html", "Start", "Steckersolar 300–800 W für Balkon & Garten (CH)"],
      ["Solaranlage kaufen Schweiz", "/solaranlage-kaufen-schweiz.html", "Start", "Photovoltaik Kosten, Pronovo-Förderung (CH)"],
      ["Photovoltaik kaufen Schweiz", "/photovoltaik-kaufen-schweiz.html", "Start", "Solaranlage, Pronovo EIV & Kosten (CH)"],
      ["Mähroboter kaufen Schweiz", "/robotermaehmaschine-kaufen-schweiz.html", "Start", "Husqvarna, Bosch & Gardena für CH-Gärten"],
      ["Pelletofen kaufen Schweiz", "/pelletofen-kaufen-schweiz.html", "Start", "Erneuerbare Heizung, Kosten & Förderung (CH)"],
      ["Luftreiniger kaufen Schweiz", "/luftreiniger-kaufen-schweiz.html", "Start", "HEPA H13/H14, CADR & Raumgrösse erklärt (CH)"],
      ["Staubsauger kaufen Schweiz", "/staubsauger-kaufen-schweiz.html", "Start", "Akkusauger, Roboter & Bodenstaubsauger (CH)"],
      ["Werkzeugkasten kaufen Schweiz", "/werkzeugkasten-kaufen-schweiz.html", "Start", "Starter-Set bis Profi-Koffer — Markenvergleich (CH)"],
      ["Gartenmöbel kaufen Schweiz", "/gartenmoebel-kaufen-schweiz.html", "Start", "Teak, Polyrattan & Alu — Lounge-Set & Essgruppe (CH)"],
      ["Waschmaschine kaufen Schweiz", "/waschmaschine-kaufen-schweiz.html", "Start", "Front- vs. Toplader, Energieklasse A, 60 cm Einbaumass (CH)"],
      ["Geschirrspüler kaufen Schweiz", "/geschirrspueler-kaufen-schweiz.html", "Start", "Einbau vs. freistehend, Energieklasse A, Aquastop (CH)"],
      ["Kühlschrank kaufen Schweiz", "/kuehlschrank-kaufen-schweiz.html", "Start", "NoFrost, Energieklasse D (neu), Volumen & Side-by-Side (CH)"],
      ["Kaffeemaschine kaufen Schweiz", "/kaffeemaschine-kaufen-schweiz.html", "Start", "Vollautomat, Siebträger & Kapselmaschine — Ratgeber (CH)"],
      ["Matratze kaufen Schweiz", "/matratze-kaufen-schweiz.html", "Start", "Härtegrad H2/H3/H4, Kaltschaum, Latex & Federkern (CH)"],
      ["Fernseher kaufen Schweiz", "/fernseher-kaufen-schweiz.html", "Start", "OLED vs. QLED, Bilddiagonale, DVB-T2 HD Schweiz"],
      ["Rasenmäher kaufen Schweiz", "/rasenmaeher-kaufen-schweiz.html", "Start", "Benzin, Akku & Roboter-Rasenmäher — Schnittbreite, Lärmschutz (CH)"],
      ["Kopfhörer kaufen Schweiz", "/kopfhoerer-kaufen-schweiz.html", "Start", "In-Ear, Over-Ear & ANC im Vergleich — Bluetooth, Codec, Akkulaufzeit (CH)"],
      ["E-Bike kaufen Schweiz", "/e-bike-kaufen-schweiz.html", "Start", "Fahrradvelo vs. Schnell-E-Bike — Rechtslage, Motor, Akku (CH)"],
      ...
      ["Pflege-Jobs Schweiz", "/pflege-jobs-schweiz.html", "Start", "Offene Pflege-Stellen (Spital/Spitex/Heim)"],
      ["Gastro-Jobs Schweiz", "/gastro-jobs-schweiz.html", "Start", "Koch, Service & Küche (CH)"],
      ["Verkauf-Jobs Schweiz", "/verkauf-jobs-schweiz.html", "Start", "Detailhandel & Beratung (CH)"],
      ["Jobs Zürich", "/jobs-zuerich.html", "Start", "Offene Stellen in der Region Zürich"],
      ["Jobs Bern", "/jobs-bern.html", "Start", "Offene Stellen in der Region Bern"],
      ["Jobs Basel", "/jobs-basel.html", "Start", "Offene Stellen in der Region Basel"],
      ["Jobs Genf", "/jobs-genf.html", "Start", "Offene Stellen in der Region Genf"],
      ["Jobs Lausanne", "/jobs-lausanne.html", "Start", "Offene Stellen in der Region Lausanne"],
      ["Jobs Lugano", "/jobs-lugano.html", "Start", "Offene Stellen im Tessin (Lugano)"],
