...
const CONFIG = {
  ...
  basteln: { coll: { handle: 'basteln-diy', title: '🎨 Basteln & DIY', tag: 'basteln' },
    ...
    anchor: ['bastelset', 'bastelbedarf', 'bastelkleber', 'bastelpapier', 'perlen', 'bügelperlen', 'moosgummi', 'filzstoff', 'filzset', 'pfeifenputzer', 'wackelaugen', 'pompons', 'pompoms', 'washi tape', 'fimo', 'polymer clay', 'modelliermasse', 'knetmasse', 'makramee', 'häkeln', 'häkelset', 'strickset', 'wolle knäuel', 'nähset', 'stickset', 'scrapbooking', 'diamond painting', 'kerzengiessen', 'seifengiessen', 'giessform silikon', 'modellbau', 'bastelfilz', 'bastelschere', 'manualidades', 'abalorios', 'fieltro', 'ganchillo', 'macramé', 'plastilina'],
