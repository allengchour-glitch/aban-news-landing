...
const CONFIG = {
  ...
  kaffee: { coll: { handle: 'kaffee-maschinen', title: '☕ Kaffee & Espresso', tag: 'kaffee' },
    ...
    anchor: ['kaffeemaschine', 'kaffeevollautomat', 'espressomaschine', 'siebträger', 'siebtrager', 'kapselmaschine', 'padmaschine', 'milchaufschäumer', 'milchaufschaumer', 'mokkakanne', 'kaffeemühle', 'kaffeemuhle', 'french press', 'cafetera'],
  ...
  beauty: { coll: { handle: 'premium-beauty', title: 'Beauty · Premium', tag: 'beauty' },
    ...
    anchor: ['make-up', 'makeup', 'lippenstift', 'lipstick', 'foundation', 'mascara', 'lidschatten', 'eyeshadow', 'concealer', 'rouge', 'nagellack', 'gesichtscreme', 'gesichtsserum', 'serum', 'gesichtsmaske', 'hautpflege', 'bb cream', 'primer', 'highlighter', 'eyeliner', 'maquillaje', 'crema facial'],
  ...
  phone: { coll: { handle: 'handy-zubehoer', title: '📱 Handy-Zubehör', tag: 'handy' },
    ...
    anchor: ['handyhülle', 'smartphone-hülle', 'handytasche', 'powerbank', 'ladekabel', 'ladegerät', 'handyhalterung', 'kfz-halterung', 'wireless charger', 'kabellos laden', 'displayschutz', 'panzerglas', 'phone case', 'funda móvil', 'cargador móvil', 'soporte móvil'],
  ...
  garten: { coll: { handle: 'garten-balkon', title: '🌿 Garten & Balkon', tag: 'garten' },
    ...
    anchor: ['blumentopf', 'übertopf', 'pflanzkübel', 'gartenleuchte', 'solarleuchte', 'gie(ss|ß)kanne', 'gartenschere', 'pflanzgefäß', 'rankgitter', 'gartenfigur', 'vogelhaus', 'gartenwerkzeug'],
  ...
  auto: { coll: { handle: 'auto-zubehoer', title: '🚗 Auto-Zubehör', tag: 'auto-zubehoer' },
    ...
    anchor: ['kfz-halterung', 'auto-halterung', 'sitzbezug', 'kofferraum-organizer', 'auto-organizer', 'lenkradbezug', 'auto-luftdüse', 'lufterfrischer auto', 'auto-staubsauger', 'auto-duft', 'rücksitz-organizer'],
    ban: ['kinder', 'spielzeug', 'modellauto', 'spielzeugauto', 'rc-auto', 'autobatterie', 'reifen komplett'],
    bullets: ['Mehr Ordnung & Komfort im Auto', 'Einfache Montage', 'Robuste Qualität', '100% Original, schnelle EU-Lieferung'] },
  camping: { coll: { handle: 'camping-outdoor', title: '⛺ Camping & Outdoor', tag: 'camping' },
    extraTags: ['camping', 'outdoor', 'reise', 'premium'], type: 'Camping', maxCost: MAX_COST_EUR,
    anchor: ['zelt', 'schlafsack', 'campingstuhl', 'isomatte', 'stirnlampe', 'kühlbox', 'campinggeschirr', 'campinglampe', 'feldbett', 'campingtisch', 'thermoskanne'],
    ban: ['kinder', 'spielzeug', 'spielzelt', 'kinderzelt', 'pop-up spielzelt'],
