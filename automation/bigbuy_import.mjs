...
const CONFIG = {
  ...
  damenmode: { coll: { handle: 'damen-mode', title: '👗 Damen-Mode', tag: 'damen' },
    ...
    anchor: ['damenkleid', 'sommerkleid', 'maxikleid', 'midikleid', 'bluse', 'damenrock', 'jumpsuit', 'damen-shirt', 'damenshirt', 'blouse', 'vestido', 'falda'],
  ...
  werkzeug: { coll: { handle: 'elektriker-werkzeug', title: '🔧 Werkzeug', tag: 'elektriker' },
    ...
    ban: ['steckdosenleiste', 'verlängerungskabel', 'mehrfachstecker', 'kabeltrommel', 'regleta', 'alargador', 'ladrón', 'steckdose euro', 'schuko', 'kinder', 'spielzeug', 'kostüm', 'aufblasbar', 'thor', 'avengers', 'nagelzange', 'eiszange', 'lockenzange', 'grillzange', 'salatzange', 'kühlzange', 'haarschneider', 'lockenstab'],
