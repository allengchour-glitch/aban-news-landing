...
const CONFIG = {
  ...
  socken: { coll: { handle: 'socken-strumpfe', title: '🧦 Socken & Strümpfe', tag: 'socken' },
    ...
    ban: ['kinder', 'baby', 'kids', 'mädchen', 'junge', 'schuhanzieher', 'sockenauszieher', 'stützstrümpfe medizin', 'kompressionsstrümpfe medizin'],
  ...
  schuhe: { coll: { handle: 'schuhe', title: '👟 Schuhe', tag: 'schuhe' },
    ...
    ban: ['kinder', 'baby', 'schuhcreme', 'schuhregal', 'einlegesohle', 'schuhspanner', 'hausschuhe', 'spielzeug', 'niño', 'niña'],
  ...
  werkzeug: { coll: { handle: 'elektriker-werkzeug', title: '🔧 Werkzeug', tag: 'elektriker' },
    ...
    anchor: ['werkzeug', 'schraubendreher', 'schraubenzieher', 'bohrer-set', 'zange', 'hammer', 'werkzeugset', 'akkuschrauber', 'wasserwaage', 'maßband', 'steckschlüssel'],
    ban: ['kinder', 'spielzeug', 'kostüm'],
