...
const CONFIG = {
  ...
  d_kuehlung: { coll: { handle: 'ventilatoren-kuehlung', title: '❄️ Ventilatoren & Kühlung', tag: 'kuehlung' },
    ...
    ban: ['pc-', 'laptop', 'cpu', 'gehäuselüfter', 'auto-kühler'],
    bullets: ['Sofortige Abkühlung an heissen Tagen', 'Akku – kabellos unterwegs', 'Leise & leicht', 'Perfekt für Büro, Balkon & Reisen'] },
  d_kuehlmatte: { coll: { handle: 'haustier-kuehlung', title: '🐾 Haustier-Sommer & Kühlung', tag: 'haustier-sommer' },
    extraTags: ['haustier', 'sommer', 'hund', 'katze'], type: 'Haustierbedarf', maxCost: MAX_COST_EUR,
    anchor: ['kühlmatte', 'kuehlmatte', 'cooling mat', 'esterilla refrescante', 'kühlweste hund', 'trinkbrunnen', 'fuente para mascotas', 'schleckmatte', 'leckmatte', 'lick mat', 'slow feeder', 'anti-schling', 'fellpflege-handschuh', 'deshedding', 'pfotenreiniger', 'hunde-trinkflasche', 'faltbarer napf'],
    ban: ['aquarium', 'terrarium', 'vogel'],
    bullets: ['Hilft deinem Liebling durch den Sommer', 'Einfach zu reinigen', 'Von Tierhaltern empfohlen', 'Schneller Versand aus EU-Lager'] },
  d_vakuum: { coll: { handle: 'ordnung-aufbewahrung', title: '🧳 Ordnung & Aufbewahrung', tag: 'ordnung' },
    extraTags: ['haushalt', 'reise', 'organisation'], type: 'Aufbewahrung', maxCost: MAX_COST_EUR,
    anchor: ['vakuumbeutel', 'vakuum-aufbewahrungsbeutel', 'vacuum storage', 'bolsas de vacío', 'kleideraufbewahrung', 'unterbettkommode', 'kompressionsbeutel', 'packwürfel', 'packing cubes', 'kofferorganizer'],
    ban: ['vakuumierer lebensmittel', 'staubsauger'],
    bullets: ['Bis 75% Platz sparen', 'Ideal für Saisonwechsel & Reisen', 'Schützt vor Staub & Feuchtigkeit', 'Wiederverwendbar'] },
  d_vorratsdosen: { coll: { handle: 'kueche-organisation', title: '🫙 Küchen-Organisation', tag: 'kueche-ordnung' },
    extraTags: ['küche', 'haushalt', 'decanting'], type: 'Küchenhelfer', maxCost: MAX_COST_EUR,
    anchor: ['vorratsdosen', 'vorratsdose', 'frischhaltedosen', 'aufbewahrungsdosen', 'recipiente hermético', 'lebensmittelbehälter', 'frischhaltebeutel silikon', 'gewürzdosen', 'gewürzregal magnetisch', 'kühlschrank-organizer', 'kühlschrank organizer'],
    ban: ['kinder', 'brotdose schule'],
    bullets: ['Luftdicht – hält länger frisch', 'Stapelbar & übersichtlich', 'Der TikTok-Ordnungstrend', 'BPA-frei'] },
  d_magsafe: { coll: { handle: 'auto-handy-laden', title: '🚗 Auto-Halterungen & Laden', tag: 'auto-laden' },
    extraTags: ['auto', 'handy', 'gadget'], type: 'Handyzubehör', maxCost: MAX_COST_EUR,
    anchor: ['magsafe', 'qi2', 'kabelloses ladegerät auto', 'handyhalterung auto laden', 'cargador inalámbrico coche', 'induktions-ladehalterung', 'kfz-ladehalterung'],
    ban: ['hülle', 'case', 'schutzglas'],
    bullets: ['Magnetisch andocken – lädt sofort', 'Stabiler Halt auf jeder Strasse', 'Für iPhone & Android (Qi)', 'Einhand-Bedienung'] },
  d_picknick: { coll: { handle: 'picknick-strand', title: '🧺 Picknick & Strand', tag: 'picknick' },
    extraTags: ['sommer', 'outdoor', 'familie'], type: 'Outdoor', maxCost: MAX_COST_EUR,
    anchor: ['picknickdecke', 'picnic blanket', 'manta de picnic', 'stranddecke', 'strandmatte', 'kühlhandtuch', 'kühltuch', 'cooling towel', 'strandmuschel', 'sonnensegel strand'],
    ban: ['hund'],
    bullets: ['Wasserdicht & faltbar', 'Perfekt für See, Park & Festival', 'Leicht zu transportieren', 'Schnell trocknend'] },
  d_solarlicht: { coll: { handle: 'solar-gartenlicht', title: '💡 Solar- & Gartenlicht', tag: 'solarlicht' },
    extraTags: ['garten', 'balkon', 'sommer', 'solar'], type: 'Beleuchtung', maxCost: MAX_COST_EUR,
    anchor: ['solar lichterkette', 'lichterkette aussen', 'lichterkette außen', 'guirnalda solar', 'solarlampe', 'solarleuchte', 'campinglampe', 'campingleuchte', 'camping-laterne', 'gartenfackel solar', 'wegleuchte solar'],
    ban: ['weihnacht', 'christbaum'],
    bullets: ['Kein Strom nötig – lädt am Tag', 'Stimmung für Balkon & Garten', 'Wetterfest', 'Automatisch an bei Dämmerung'] },
  ...
  damenmode: { coll: { handle: 'damen-mode', title: '👗 Damen-Mode', tag: 'damen' },
    extraTags: ['sommer-2026', 'kleid', 'premium'], type: 'Damenmode', maxCost: MAX_COST_EUR, word: true,
    anchor: ['damenkleid', 'kleid', 'sommerkleid', 'maxikleid', 'midikleid', 'abendkleid', 'cocktailkleid', 'strandkleid', 'wickelkleid', 'bluse', 'damenbluse', 'tunika', 'damenrock', 'rock', 'minirock', 'maxirock', 'leggings', 'damenhose', 'damenjeans', 'damentop', 'damen-shirt', 'damenshirt', 'damenjacke', 'strickjacke', 'damenmantel', 'damen-pullover', 'damenpullover', 'strickpullover', 'jumpsuit', 'overall', 'poncho', 'blouse', 'vestido', 'falda', 'blusa', 'chaqueta mujer', 'pantalón mujer'],
    ban: ['kostüm', 'hexe', 'totenkopf', 'halloween', 'karneval', 'fasching', 'disney', 'wonder woman', 'superman', 'cosplay', 'verkleidung', 'lingerie', 'dessous', 'seven til midnight', 'werkzeug', 'organizer', 'gt line', 'turtle', 'koffer', 'tool', 'bohr', 'säge'],
  ...
  gaming: { coll: { handle: 'gaming', title: '🎮 Gaming', tag: 'gaming' },
    extraTags: ['gaming', 'tech', 'hype-2026', 'geschenk'], type: 'Gaming', maxCost: MAX_COST_EUR, word: true,
    anchor: ['gaming controller', 'gamepad', 'gaming headset', 'joy-con', 'joycon', 'playstation', 'ps4', 'ps5', 'dualsense', 'dualshock', 'xbox', 'nintendo', 'nintendo switch', 'gaming-maus', 'gaming maus', 'gaming-tastatur', 'mechanische tastatur', 'mauspad', 'mousepad', 'joystick', 'lenkrad gaming', 'racing wheel', 'gaming-stuhl', 'gaming stuhl', 'spielkonsole', 'retro-konsole', 'handheld konsole', 'arcade stick', 'arcade automat', 'gaming-monitor', 'capture card', 'streaming mikrofon', 'controller ladestation', 'ladestation controller', 'rgb-tastatur', 'gaming-brille', 'konsolen-zubehör'],
    ban: ['kinder', 'spielzeug', 'baby', 'toy', 'aufkleber', 'sticker', 'mandoline', 'reibe', 'gemüseschneider', 'reibeisen', 'choppie', 'kostüm', 'tasche', 'rucksack', 'hülle', 'funda', 'sweatshirt', 't-shirt', 'lichtschalter', 'netzwerk-switch'],
  ...
  bambu3d: { coll: { handle: '3d-druck', title: '🖨️ 3D-Druck', tag: '3d-druck' },
    extraTags: ['3d-druck', '3d-drucker', 'filament', 'marken', 'tech', 'hobby', 'premium'], type: '3D-Druck', maxCost: 700, word: true,
    anchor: ['bambu lab', 'bambulab', 'creality', 'anycubic', 'elegoo', 'prusa', 'flashforge', 'sovol', 'artillery', 'qidi', 'kingroon', 'voron', 'raise3d', 'ultimaker', 'sunlu', 'polymaker', 'esun', 'overture', 'prusament', 'polyterra'],
    ban: ['kinder', 'spielzeug', 'aufkleber', 'kostüm', 'malbuch', 'puzzle', 'nachahmung', 'replica'],
    bullets: ['Original Marken-3D-Druck (Bambu Lab, Creality & Co.)', 'Präzise Ergebnisse für Maker', 'Drucker, Filament & Zubehör', '100% Original, schnelle EU-Lieferung'] },
  basteln: { coll: { handle: 'basteln-diy', title: '🎨 Basteln & DIY', tag: 'basteln' },
    extraTags: ['basteln', 'diy', 'hobby', 'kreativ', 'geschenk'], type: 'Bastelbedarf', maxCost: 90, word: true,
    anchor: ['bastelset', 'bastelbedarf', 'bastelkleber', 'bastelpapier', 'bügelperlen', 'bastelperlen', 'holzperlen', 'moosgummi', 'filzstoff', 'filzset', 'pfeifenputzer', 'wackelaugen', 'pompons', 'pompoms', 'washi tape', 'fimo', 'polymer clay', 'modelliermasse', 'knetmasse', 'makramee', 'häkeln', 'häkelset', 'strickset', 'wolle knäuel', 'nähset', 'stickset', 'scrapbooking', 'diamond painting', 'kerzengiessen', 'seifengiessen', 'giessform silikon', 'modellbau', 'bastelfilz', 'bastelschere', 'manualidades', 'abalorios', 'fieltro', 'ganchillo', 'macramé', 'plastilina'],
    ban: ['waffe', 'messer set küche', 'elektronik', 'handy', 'drucker', 'thomas sabo', 'viceroy', 'pandora', 'damenring', 'armreif'],
    bullets: ['Für kleine & grosse Bastler', 'Kreativ-Spass für Kinder & Erwachsene', 'Komplett-Sets & Zubehör', '100% Original, schnelle EU-Lieferung'] },
  makerelektronik: { coll: { handle: 'maker-elektronik', title: '🔌 Elektronik für Bastler', tag: 'maker' },
    extraTags: ['maker', 'diy', 'elektronik', 'hobby', 'tech'], type: 'Elektronik-Bauteile', maxCost: 150, word: true,
    anchor: ['arduino', 'raspberry pi', 'breadboard', 'steckplatine', 'protoboard', 'jumper kabel', 'dupont kabel', 'widerstand set', 'widerstände', 'resistencia', 'led-set', 'led sortiment', 'lötkolben', 'lötstation', 'soldador', 'lötzinn', 'sensor modul', 'sensor-set', 'esp32', 'esp8266', 'nodemcu', 'motortreiber', 'schrittmotor', 'servo motor', 'relais modul', 'potentiometer', 'transistor set', 'kondensator set', 'leiterplatte', 'lochrasterplatine', 'multimeter', 'oszilloskop', 'netzteil labor', 'krokodilklemmen', 'schrumpfschlauch set'],
    ban: ['spielzeug', 'kostüm', 'kinder ab 3', 'ferngesteuert auto', 'drohne'],
    bullets: ['Für Maker, Tüftler & Elektronik-Bastler', 'Arduino, Sensoren, Löten & mehr', 'Bauteile & Komplett-Kits', '100% Original, schnelle EU-Lieferung'] },
  hightech: { coll: { handle: 'hightech-gadgets', title: '⚡ Hightech & Gadgets', tag: 'hightech' },
    extraTags: ['hightech', 'tech', 'gadget', 'innovation', 'hype-2026', 'geschenk'], type: 'Hightech', maxCost: 500, word: true,
    anchor: ['saugroboter', 'staubsaugerroboter', 'roboterstaubsauger', 'wischroboter', 'mähroboter', 'vr-brille', 'vr brille', 'vr-headset', 'vr headset', 'virtual reality', '3d-brille', 'überwachungskamera', 'wlan-kamera', 'ip-kamera', 'action-cam', 'action cam', 'actionkamera', 'gimbal', 'e-scooter', 'elektroroller', 'elektro-scooter', 'hoverboard', 'e-bike', 'elektrofahrrad', 'elektro-skateboard', 'lasergravierer', 'laser-gravur', 'laser-graviermaschine', 'massagepistole', 'massage-pistole', 'selfie-drohne', 'faltdrohne', 'roboter-arm', 'smart-home-hub', 'smarte türklingel', 'wlan-steckdose', 'led-projektor', 'nachtsichtgerät', 'wärmebildkamera', 'bluetooth-tracker', 'gps-tracker', 'translator-gerät', 'übersetzer-gerät'],
    ban: ['kinder', 'spielzeug', 'baby', 'toy', 'kostüm', 'aufkleber', 'sticker', 'zahnbürste', 'küchenmaschine'],
    bullets: ['Neueste Technik & smarte Gadgets', 'Innovation für Zuhause & unterwegs', 'Robo-Sauger, VR, E-Mobility & mehr', '100% Original, schnelle EU-Lieferung'] },
  beautytech: { coll: { handle: 'beauty-geraete', title: '💆 Beauty-Geräte & Haarentfernung', tag: 'beautytech' },
    extraTags: ['beautytech', 'beauty', 'pflege', 'gadget', 'geschenk'], type: 'Beauty-Gerät', maxCost: 200, word: true,
    anchor: ['haarentfernung', 'ipl-gerät', 'ipl gerät', 'ipl haarentfernung', 'epilierer', 'epiliergerät', 'gesichtsreinigungsbürste', 'gesichtsbürste', 'led-maske', 'led gesichtsmaske', 'led-gesichtsmaske', 'gesichtsmassagegerät', 'mikrostrom', 'gua sha', 'facial steamer', 'gesichtssauna', 'gesichtsdampfer', 'mitesserentferner', 'porenreiniger', 'mikrodermabrasion', 'ultraschall-peeling', 'depiladora', 'lymphdrainage-gerät', 'radiofrequenz-gerät', 'nasenhaartrimmer', 'gesichtsroller'],
    ban: ['kinder', 'spielzeug', 'creme', 'serum', 'shampoo', 'make-up', 'lippenstift'],
    bullets: ['Kosmetikstudio für zuhause', 'Sanfte, wirksame Technik', 'Spart Zeit & Geld', '100% Original, schnelle EU-Lieferung'] },
  autozubehoer: { coll: { handle: 'auto-kfz-zubehoer', title: '🚗 Auto & KFZ-Zubehör', tag: 'auto' },
    extraTags: ['auto', 'kfz', 'gadget', 'zubehör', 'geschenk'], type: 'Auto-Zubehör', maxCost: 150, word: true,
    anchor: ['dashcam', 'dash cam', 'kfz-ladegerät', 'auto-ladegerät', 'starthilfe', 'starthilfekabel', 'reifendruckmesser', 'reifenreparaturset', 'reifenpumpe', 'auto-luftpumpe', 'auto-handyhalter', 'handyhalter auto', 'auto-organizer', 'kofferraum-organizer', 'autostaubsauger', 'auto-staubsauger', 'sitzbezug auto', 'lenkradbezug', 'auto-fussmatten', 'parksensor', 'rückfahrkamera', 'kfz-set', 'obd2', 'auto-diagnose', 'scheibenwischer', 'auto-sonnenschutz', 'nackenkissen auto'],
    ban: ['kinder', 'spielzeug', 'modellauto', 'ferngesteuert', 'rc-auto', 'aufkleber', 'sticker'],
    bullets: ['Praktische Helfer fürs Auto', 'Sicherheit & Komfort unterwegs', 'Einfache Montage', '100% Original, schnelle EU-Lieferung'] },
  heizdecke: { coll: { handle: 'kuschel-heizdecken', title: '🛋️ Kuschel- & Heizdecken', tag: 'heizdecke' },
    extraTags: ['heizdecke', 'wohnen', 'winter', 'wellness', 'geschenk'], type: 'Heizdecke', maxCost: 160, word: true,
  ...
  raucherzubehoer: { coll: { handle: 'raucherzubehoer', title: '🚬 Raucher- & Dreh-Zubehör', tag: 'raucher' },
    ...
    anchor: ['tabakpfeife', 'tabakmühle', 'kräutermühle', 'grinder', 'zigarettendrehmaschine', 'drehmaschine tabak', 'tischdrehmaschine', 'zigarettenetui', 'zigarettenspitze', 'sturmfeuerzeug', 'benzinfeuerzeug', 'shisha', 'wasserpfeife', 'picadora tabaco', 'liar cigarrillos', 'cachimba', 'pipa de tabaco', 'mechero gasolina', 'ocb', 'rizla', 'gizeh', 'clipper feuerzeug', 'clipper mechero', 'clipper metall', 'papel de fumar', 'papers king size', 'drehpapier', 'blättchen', 'zigarettenfilter', 'drehfilter'],
    ban: ['kinder', 'spielzeug', 'baby', 'signalpfeife', 'hundepfeife', 'trillerpfeife', 'vape', 'e-zigarette', 'e-shisha', 'nikotin', 'liquid', 'cbd', 'thc', 'cannabis', 'auto', 'deko', 'haarschneider', 'nagelknipser', 'haarschneidemaschine', 'g-star', 'nasenhaar'],
    bullets: ['Für Genießer & Selbstdreher', 'Robuste, langlebige Qualität', 'Diskret verpackt geliefert', 'Nur für Erwachsene ab 18 Jahren'] },
  grow: { coll: { handle: 'indoor-grow', title: '🌱 Indoor-Gärtnern & Grow', tag: 'grow' },
    extraTags: ['grow', 'indoor-garten', 'anzucht', 'zubehoer'], type: 'Grow-Zubehör', maxCost: 200, word: true, onlineOnly: true,
    anchor: ['pflanzenlampe', 'pflanzenlicht', 'grow-lampe', 'grow lampe', 'grow-licht', 'led grow', 'vollspektrum lampe', 'vollspektrum pflanzen', 'grow-zelt', 'grow zelt', 'growbox', 'grow box', 'anzuchtset', 'anzuchttopf', 'anzuchtschale', 'mini-gewächshaus', 'zimmergewächshaus', 'hydroponik', 'hydrokultur', 'pflanzendünger', 'anzuchterde', 'bewässerungsset', 'tröpfchenbewässerung', 'ph-messgerät', 'ph-meter', 'abluftventilator', 'grow-ventilator', 'lámpara de cultivo', 'invernadero'],
    ban: ['kunstpflanze', 'künstliche pflanze', 'deko-pflanze', 'gartenschlauch', 'rasenmäher', 'kunstblume', 'plüsch', 'spielzeug', 'kinder'],
    bullets: ['Für Indoor-Gärtner & Selbstversorger', 'Kräuter, Chili, Gemüse & Zierpflanzen ziehen', 'Pflanzenlampen, Anzucht & Bewässerung', 'Robuste Qualität, schnelle EU-Lieferung'] },
  ...
  spielzeug: { coll: { handle: 'kinderspielzeug', title: '🧸 Kinderspielzeug', tag: 'spielzeug' },
    extraTags: ['spielzeug', 'kinder', 'geschenk', 'familie'], type: 'Spielzeug', maxCost: MAX_COST_EUR, word: true,
    anchor: ['spielzeug', 'spielset', 'plüschtier', 'plüsch', 'kuscheltier', 'stofftier', 'bauklötze', 'bausteine', 'bausatz', 'baukasten', 'lernspielzeug', 'holzspielzeug', 'puppe', 'puppenhaus', 'spielfigur', 'sammelfigur', 'actionfigur', 'brettspiel', 'gesellschaftsspiel', 'kartenspiel', 'kinderpuzzle', 'puzzle', 'steckspiel', 'motorikspielzeug', 'spielküche', 'kaufladen', 'modellauto', 'modellbausatz', 'ferngesteuert', 'rc-auto', 'knete', 'malset', 'bastelset', 'experimentierkasten', 'zauberkasten', 'murmelbahn', 'holzeisenbahn', 'spielzelt', 'kinderzelt', 'jonglier', 'kreisel', 'spielteppich', 'greifling', 'rassel', 'nachziehtier', 'schaukeltier', 'stapelturm', 'sortierbox', 'lernuhr', 'globus kinder', 'quiz-spiel', 'würfelspiel', 'geschicklichkeitsspiel'],
    ban: ['erwachsene', 'sex', 'erotik', 'dessous', 'waffe echt', 'munition', 'softair', 'gaming', 'controller'],
  ...
  beautybrands: { coll: { handle: 'premium-beauty', title: 'Beauty · Premium', tag: 'beauty' },
  ...
  herrenmode: { coll: { handle: 'fur-ihn', title: '👨 Für Ihn', tag: 'herren' },
    extraTags: ['herren', 'mode', 'streetwear', 'premium'], type: 'Herrenmode', maxCost: MAX_COST_EUR, sized: true, word: true,
    anchor: ['herrenhemd', 'herren-hemd', 'hemd', 'poloshirt', 'polohemd', 'herren t-shirt', 'herren-t-shirt', 'herrenshirt', 'herrenhose', 'herren-hose', 'herrenjeans', 'chino', 'herren-pullover', 'herrenpullover', 'kapuzenpullover', 'herren-hoodie', 'herrenhoodie', 'herren-sweatshirt', 'herrenjacke', 'herren-jacke', 'herrenmantel', 'sakko', 'blazer', 'herrenweste', 'herren-shorts', 'boxershorts', 'unterhemd', 'krawatte', 'fliege', 'camiseta hombre', 'sudadera hombre', 'camisa hombre', 'pantalón hombre'],
    ban: ['damen', 'kinder', 'baby', 'mujer', 'niño', 'niña', 'mädchen', 'jungen', 'kids', 'damenhemd', 'blusenhemd damen'],
  ...
  werkzeug: { coll: { handle: 'elektriker-werkzeug', title: '🔧 Werkzeug', tag: 'elektriker' },
    extraTags: ['werkzeug', 'heimwerker', 'premium'], type: 'Werkzeug', maxCost: 400, word: true,
    anchor: ['werkzeug', 'werkzeugset', 'werkzeugkoffer', 'werkzeugkasten', 'schraubendreher', 'schraubenzieher', 'bohrmaschine', 'bohrhammer', 'schlagbohrmaschine', 'akkubohrer', 'akkuschrauber', 'bohrschrauber', 'bohrer', 'bohrer-set', 'bit-set', 'kombizange', 'zange', 'seitenschneider', 'spitzzange', 'abisolierzange', 'nietzange', 'blindnietzange', 'hammer', 'vorschlaghammer', 'wasserwaage', 'maßband', 'zollstock', 'steckschlüssel', 'ratsche', 'ratschenschlüssel', 'maulschlüssel', 'ringschlüssel', 'inbusschlüssel', 'schraubenschlüssel', 'drehmomentschlüssel', 'säge', 'handsäge', 'stichsäge', 'kreissäge', 'winkelschleifer', 'schleifmaschine', 'schleifer', 'exzenterschleifer', 'bandschleifer', 'oberfräse', 'fräse', 'hobel', 'meißel', 'feile', 'raspel', 'schraubstock', 'schraubzwinge', 'zwinge', 'spachtel', 'teppichmesser', 'cuttermesser', 'lötkolben', 'lötstation', 'multimeter', 'heißluftpistole', 'heißklebepistole', 'klebepistole', 'trennscheibe', 'schleifpapier', 'akkuschleifer', 'poliermaschine', 'tacker', 'nagelpistole', 'drucklufttacker', 'werkbank', 'schleifbock', 'akku-werkzeug', 'elektrowerkzeug', 'handwerkzeug', 'werkzeugtasche', 'werkzeuggürtel'],
    ban: ['steckdosenleiste', 'verlängerungskabel', 'mehrfachstecker', 'kabeltrommel', 'regleta', 'alargador', 'ladrón', 'steckdose euro', 'schuko', 'kinder', 'spielzeug', 'kostüm', 'aufblasbar', 'thor', 'avengers', 'nagelzange', 'eiszange', 'lockenzange', 'grillzange', 'salatzange', 'kühlzange', 'haarschneider', 'lockenstab', 'nagelknipser', 'maniküre', 'pediküre', 'epilierer', 'bartschneider', 'nasenhaartrimmer', 'küchenmaschine', 'nähmaschine'],
  ...
  basteln: { coll: { handle: 'basteln-diy', title: '🎨 Basteln & DIY', tag: 'basteln' },
    extraTags: ['basteln', 'diy', 'hobby', 'kreativ', 'geschenk'], type: 'Bastelbedarf', maxCost: 90, word: true,
    anchor: ['bastelset', 'bastelbedarf', 'bastelkleber', 'bastelpapier', 'bügelperlen', 'bastelperlen', 'holzperlen', 'moosgummi', 'filzstoff', 'filzset', 'pfeifenputzer', 'wackelaugen', 'pompons', 'pompoms', 'washi tape', 'fimo', 'polymer clay', 'modelliermasse', 'knetmasse', 'makramee', 'häkeln', 'häkelset', 'strickset', 'wolle knäuel', 'nähset', 'stickset', 'scrapbooking', 'diamond painting', 'kerzengiessen', 'seifengiessen', 'giessform silikon', 'modellbau', 'bastelfilz', 'bastelschere', 'manualidades', 'abalorios', 'fieltro', 'ganchillo', 'macramé', 'plastilina'],
    ban: ['waffe', 'messer set küche', 'elektronik', 'handy', 'drucker'],
    bullets: ['Für kleine & grosse Bastler', 'Kreativ-Spass für Kinder & Erwachsene', 'Komplett-Sets & Zubehör', '100% Original, schnelle EU-Lieferung'] },
  makerelektronik: { coll: { handle: 'maker-elektronik', title: '🔌 Elektronik für Bastler', tag: 'maker' },
    extraTags: ['maker', 'diy', 'elektronik', 'hobby', 'tech'], type: 'Elektronik-Bauteile', maxCost: 150, word: true,
    anchor: ['arduino', 'raspberry pi', 'breadboard', 'steckplatine', 'protoboard', 'jumper kabel', 'dupont kabel', 'widerstand set', 'widerstände', 'resistencia', 'led-set', 'led sortiment', 'lötkolben', 'lötstation', 'soldador', 'lötzinn', 'sensor modul', 'sensor-set', 'esp32', 'esp8266', 'nodemcu', 'motortreiber', 'schrittmotor', 'servo motor', 'relais modul', 'potentiometer', 'transistor set', 'kondensator set', 'leiterplatte', 'lochrasterplatine', 'multimeter', 'oszilloskop', 'netzteil labor', 'krokodilklemmen', 'schrumpfschlauch set'],
  ...
  wandern: { coll: { handle: 'camping-outdoor', title: '🥾 Wandern & Trekking', tag: 'camping' },
    extraTags: ['wandern', 'outdoor', 'sport', 'herren', 'damen'], type: 'Wandern & Trekking', maxCost: 120,
  ...
  einhell: { coll: { handle: 'elektriker-werkzeug', title: '🔧 Werkzeug', tag: 'elektriker' },
    extraTags: ['werkzeug', 'einhell', 'elektrowerkzeug', 'heimwerker', 'premium', 'marken'], type: 'Werkzeug', maxCost: 400, word: true,
    anchor: ['einhell'], ban: ['kinder', 'spielzeug', 'kostüm', 'nachahmung', 'replica'],
    bullets: ['Original Einhell – Werkzeug & Garten', 'Für Heimwerker gemacht', 'Gutes Preis-Leistungs-Verhältnis', '100% Original, schnelle EU-Lieferung'] },
  wuerth: { coll: { handle: 'elektriker-werkzeug', title: '🔧 Werkzeug', tag: 'elektriker' },
    extraTags: ['werkzeug', 'würth', 'wuerth', 'heimwerker', 'profi', 'premium', 'marken'], type: 'Werkzeug', maxCost: 400, word: true,
    anchor: ['würth', 'wurth'], ban: ['kinder', 'spielzeug', 'kostüm', 'nachahmung', 'replica'],
    bullets: ['Original Würth – Profi-Qualität', 'Befestigung, Werkzeug & Chemie', 'Vom Handwerks-Marktführer', '100% Original, schnelle EU-Lieferung'] },
  hilti: { coll: { handle: 'elektriker-werkzeug', title: '🔧 Werkzeug', tag: 'elektriker' },
    extraTags: ['werkzeug', 'hilti', 'elektrowerkzeug', 'profi', 'premium', 'marken'], type: 'Werkzeug', maxCost: 400, word: true,
    anchor: ['hilti'], ban: ['kinder', 'spielzeug', 'kostüm', 'nachahmung', 'replica'],
    bullets: ['Original HILTI – Profi-Baumaschinen', 'Bohren, Meißeln, Befestigen', 'Härteste Baustellen-Qualität', '100% Original, schnelle EU-Lieferung'] },
  ...
  elektronik: { coll: { handle: 'elektronik-technik', title: '📱 Elektronik & Technik', tag: 'elektronik' },
    extraTags: ['elektronik', 'tech', 'gadget', 'premium'], type: 'Elektronik', maxCost: 250, word: true,
    anchor: ['tastatur', 'computermaus', 'pc-maus', 'webcam', 'monitor', 'festplatte', 'externe festplatte', 'ssd', 'usb-stick', 'usb-hub', 'usb-stick', 'speicherkarte', 'sd-karte', 'micro-sd', 'kartenleser', 'router', 'wlan-repeater', 'repeater', 'wlan-stick', 'netzwerkswitch', 'fernseher', 'tablet', 'e-reader', 'action-cam', 'überwachungskamera', 'ip-kamera', 'wlan-kamera', 'wildkamera', 'drucker', 'scanner', 'mikrofon', 'dockingstation', 'grafiktablett', 'festplattengehäuse', 'usb-c-hub', 'hdmi-kabel', 'displayport', 'präsentationslaser', 'laserpointer', 'digitaler bilderrahmen', 'diktiergerät', 'übersetzer', 'e-book-reader', 'tv-stick', 'streaming-stick', 'mini-pc', 'grafikkarte', 'arbeitsspeicher', 'mainboard'],
    ban: ['kinder', 'spielzeug', 'kostüm', 'hülle', 'case', 'schutzfolie', 'displayschutz', 'baby', 'ersatzteil', 'toner', 'tintenpatrone', 'druckerpapier', 'halterung', 'ständer einzeln'],
    bullets: ['Moderne Technik für Alltag & Büro', 'Zuverlässig & einfach', 'Top Preis-Leistung', '100% Original, schnelle EU-Lieferung'] },
  ...
  auto: { coll: { handle: 'auto-zubehoer', title: '🚗 Auto-Zubehör', tag: 'auto-zubehoer' },
    ...
    ban: ['steckdosenleiste', 'verlängerungskabel', 'mehrfachstecker', 'kabeltrommel', 'regleta', 'alargador', 'ladrón', 'steckdose euro', 'schuko', 'kinder', 'spielzeug', 'modellauto', 'spielzeugauto', 'rc-auto', 'autobatterie', 'reifen komplett', 'ersatzteil', 'bremsbelag', 'zündkerze', 'ölfilter', 'scheibenwischer', 'stoßstange', 'kotflügel'],
  ...
  beleuchtung: { coll: { handle: 'sub-beleuchtung', title: '💡 Beleuchtung & Lampen', tag: 'beleuchtung' },
    ...
    ban: ['steckdosenleiste', 'verlängerungskabel', 'mehrfachstecker', 'kabeltrommel', 'regleta', 'alargador', 'ladrón', 'steckdose euro', 'schuko', 'kinder', 'spielzeug', 'taschenlampe billig', 'auto', 'fahrradlicht'],
