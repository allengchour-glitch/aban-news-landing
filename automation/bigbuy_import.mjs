...
const CONFIG = {
  ...
  damenmode: { coll: { handle: 'damen-mode', title: '👗 Damen-Mode', tag: 'damen' },
    ...
    ban: ['herren', 'kinder', 'baby', 'men ', 'kids', 'uhr', 'sonnenbrille', 'brille', 'ring ', 'kette', 'armband', 'ohrring', 'tasche', 'rucksack', 'schuh', 'parfum', 'geldbörse', 'portemonnaie', 'kostüm', 'karneval'],
  ...
  parfum: { coll: { handle: 'parfum-duefte', title: '🌸 Parfum & Düfte', tag: 'parfum' },
    ...
    ban: ['kinder', 'spielzeug', 'raumduft', 'diffuser', 'auto', 'lufterfrischer', 'nachfüll', 'kerze', 'duftkerze', 'waschmittel', 'deo ', 'roll-on'],
  ...
  lederwaren: { coll: { handle: 'lederwaren', title: '👝 Leder & Accessoires', tag: 'leder' },
    ...
    ban: ['kinder', 'spielzeug', 'auto', 'hund', 'werkzeug', 'koffer', 'laptop', 'notebook'],
