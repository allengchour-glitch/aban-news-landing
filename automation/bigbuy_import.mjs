...
const CONFIG = {
  ...
  tauchen: { coll: { handle: 'tauchen-schnorcheln', title: '🤿 Tauchen & Schnorcheln', tag: 'tauchen' },
    ...
    ban: ['kinder', 'aufblasbar', 'schwimmflügel', 'spielzeug'],
  ...
  velo: { coll: { handle: 'velo-radsport', title: '🚲 Velo & Radsport', tag: 'velo' },
    ...
    anchor: ['fahrrad', 'velo', 'rennrad', 'radsport', 'fahrradhelm', 'fahrradlicht', 'fahrradtasche', 'fahrradcomputer', 'radtrikot', 'radhose', 'fahrradschloss'],
    ban: ['kinder', 'dreirad', 'laufrad', 'stützräder', 'spielzeug'],
