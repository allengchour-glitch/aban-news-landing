...
const CONFIG = {
  ...
  gaming: { coll: { handle: 'gaming', title: '🎮 Gaming', tag: 'gaming' },
    ...
    anchor: ['gaming controller', 'gamepad', 'gaming headset', 'joy-con', 'joycon', 'playstation', 'ps4', 'ps5', 'dualsense', 'dualshock', 'xbox', 'nintendo', 'nintendo switch', 'gaming-maus', 'gaming maus', 'gaming-tastatur', 'mechanische tastatur', 'mauspad', 'mousepad', 'joystick', 'lenkrad gaming', 'racing wheel', 'gaming-stuhl', 'gaming stuhl', 'spielkonsole', 'retro-konsole', 'handheld konsole', 'arcade', 'gaming-monitor', 'capture card', 'streaming mikrofon', 'controller ladestation', 'ladestation controller', 'rgb-tastatur', 'gaming-brille', 'konsolen-zubehör'],
