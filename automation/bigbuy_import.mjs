...
const CONFIG = {
  ...
  guertel: { coll: { handle: 'guertel', title: '👖 Gürtel', tag: 'Gürtel' },
    ...
    ban: ['kinder', 'spielzeug', 'werkzeuggürtel', 'tool belt', 'sicherheitsgurt', 'hund', 'auto', 'getriebe', 'zahnriemen', 'keilriemen', 'lüfter', 'rückenstütze', 'massage'],
  ...
  haustier: { coll: { handle: 'sub-haustier', title: '🐾 Haustier', tag: 'haustier' },
    ...
    anchor: ['hundehalsband', 'hundeleine', 'hundebett', 'hundebürste', 'hundespielzeug', 'katzenbaum', 'kratzbaum', 'katzenspielzeug', 'katzenstreu', 'futternapf', 'napf', 'transportbox', 'haustier', 'comedero', 'rascador', 'collar perro', 'correa perro'],
    ban: ['kinder', 'aufkleber', 'sticker', 'auto', 'toy car', 'verkleidung mensch'],
