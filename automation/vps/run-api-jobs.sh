...
log "WM-Trikot-Preise profitabel setzen (perso 59.90 / blank 49.90, idempotent)..."
"$NODE" automation/set_trikot_prices.mjs 2>&1 | tail -4 || log "set_trikot_prices Fehler (weiter)"
