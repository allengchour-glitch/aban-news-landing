@echo off
REM ============================================================================
REM  LuxeStyle - Baernduetsch mit GEKLONTER Stimme erzeugen (PC, nach SETUP-VOICECLONE).
REM  Referenz-WAV (rechte-geklaert!) + Baernduetsch-Text -> klingt wie die Referenz.
REM ============================================================================
setlocal
cd /d "%~dp0"
...
set /p GENTXT="Baernduetsch-Text der gesprochen werden soll: "
...
echo Tipp: Berner Referenz + Baernduetsch-Text = authentischer Schwiizer-Klang.
pause
