...
function Run-Cmd($c) {
  ...
  switch ($c) {
    "tutti"    { $env:AUTO_PUBLISH="1"; $env:TUTTI_CAP="3"; node "automation/local/tutti-post.mjs" }
    "anibis"   { $env:AUTO_PUBLISH="1"; $env:ANIBIS_CAP="3"; node "automation/local/anibis-post.mjs" }
