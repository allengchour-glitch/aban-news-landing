...
for(const n of names){
  ...
  const input={ title, handle:'pod-sticker-'+n, productType:'Sticker', vendor:'LuxeStyle', status:'ACTIVE',
    ...
    seo:{ title:`Sticker «${name}» – wetterfest & UV-beständig | LuxeStyle`, description:`Vinyl-Sticker «${name}» (${THEME_DE[th]||th}), wetterfest & kratzfest, 3 Grössen. In Europa gedruckt. Gratis-Versand ab CHF 50.` },
    tags,
