...
const PAGES = [
  ...
  },
  {
    ...
    tips: [
      ["Leistung", "Mehr Watt trocknet schneller; mehrere Temperatur- und Gebläsestufen schonen das Haar."],
      ["Ionen-Funktion", "Ionen sollen das Haar glatter und weniger statisch machen — angenehm bei langem Haar."],
      ["Aufsätze", "Eine Stylingdüse für gezieltes Föhnen, ein Diffusor für Locken — auf das passende Zubehör achten."],
    ],
    faq: [
      ["Wie viel Watt brauche ich?", "Für die meisten reicht mittlere Leistung; bei dichtem oder langem Haar trocknet ein leistungsstärkeres Gerät schneller."],
      ["Was bringt die Ionen-Funktion?", "Sie kann das Haar glatter und weniger statisch erscheinen lassen — der Effekt ist individuell, aber besonders bei langem Haar angenehm."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Plattenmaterial", "Keramik- oder Turmalinplatten gleiten sanft und verteilen die Wärme gleichmässig."],
      ["Temperatur", "Eine einstellbare Temperatur schützt das Haar — feines Haar braucht weniger Hitze als dickes."],
      ["Plattenbreite", "Schmale Platten für kurzes Haar und Pony, breite für langes, dichtes Haar."],
    ],
    faq: [
      ["Welche Temperatur ist gut fürs Haar?", "So niedrig wie möglich für ein gutes Ergebnis — feines Haar braucht weniger Hitze, dickes mehr. Ein Hitzeschutz schont zusätzlich."],
      ["Welches Plattenmaterial ist besser?", "Keramik und Turmalin gleiten sanft und verteilen die Wärme gleichmässig — das schont das Haar gegenüber einfachen Metallplatten."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Pinzetten", "Mehr Pinzetten erfassen mehr Haare pro Zug; mehrere Stufen erlauben sanftes oder schnelles Arbeiten."],
      ["Nass & Trocken", "Wasserfeste Modelle lassen sich unter der Dusche nutzen — das macht die Anwendung angenehmer."],
      ["Aufsätze", "Massage-, Präzisions- und Trimmeraufsätze erweitern den Einsatz an verschiedenen Körperstellen."],
    ],
    faq: [
      ["Tut Epilieren weh?", "Am Anfang kann es ziehen; mit Gewöhnung und der Anwendung unter warmem Wasser wird es angenehmer. Sanfte Stufen helfen beim Einstieg."],
      ["Nass oder trocken?", "Trockenanwendung geht schnell; wasserfeste Geräte erlauben das Epilieren unter der Dusche, was viele als weniger unangenehm empfinden."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Längenstufen", "Viele, fein abgestufte Längen erlauben präzises Stylen vom Drei-Tage-Bart bis zum Vollbart."],
      ["Akku & Reinigung", "Lange Akkulaufzeit und abwaschbare Klingen erleichtern den Alltag."],
      ["Aufsätze", "Präzisions- und Konturaufsätze formen Kanten; ein Nasenhaartrimmer ist ein praktisches Extra."],
    ],
    faq: [
      ["Worauf beim Bartschneider achten?", "Auf viele Längenstufen, eine gute Akkulaufzeit und leicht zu reinigende (am besten abwaschbare) Klingen achten."],
      ["Mit Kabel oder Akku?", "Akkugeräte sind flexibler und reisefreundlich; Modelle mit Netzbetrieb sind praktisch, falls der Akku leer ist."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Technik", "Schallzahnbürsten schwingen schnell, Rotationsbürsten drehen den Kopf — beide reinigen gut; wichtig ist die richtige Anwendung."],
      ["Funktionen", "Timer und Andruckkontrolle helfen, schonend und lange genug zu putzen."],
      ["Folgekosten", "Auf die Verfügbarkeit und den Preis der Ersatzbürstenköpfe achten — sie fallen regelmässig an."],
    ],
    faq: [
      ["Schall oder Rotation?", "Beide reinigen gut — Schallbürsten arbeiten mit schnellen Schwingungen, Rotationsbürsten mit drehendem Kopf. Entscheidend ist die richtige Technik und ein Timer."],
      ["Worauf bei den Folgekosten achten?", "Ersatzbürstenköpfe fallen regelmässig an — prüfe Preis und Verfügbarkeit, bevor du dich für ein System entscheidest."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Bauart", "Stationäre Geräte haben grosse Tanks fürs Bad; Akku-Modelle sind kompakt und reisetauglich."],
      ["Druckstufen", "Mehrere Stufen erlauben einen sanften Start und kräftigere Reinigung nach Gewöhnung."],
      ["Tank & Düsen", "Ein grösserer Tank muss seltener nachgefüllt werden; wechselbare Düsen sind für mehrere Nutzer praktisch."],
    ],
    faq: [
      ["Ersetzt eine Munddusche die Zahnseide?", "Sie ergänzt die Reinigung der Zwischenräume, ersetzt aber Zähneputzen nicht. Viele finden sie als zusätzliche Pflege angenehm und einfach."],
      ["Stationär oder mit Akku?", "Stationäre Geräte haben grosse Tanks fürs Zuhause; Akku-Mundduschen sind kompakt und gut für unterwegs."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Leistung & Stufen", "Mehrere Intensitätsstufen erlauben sanfte oder kräftige Anwendung an verschiedenen Muskelgruppen."],
      ["Lautstärke & Akku", "Leise Geräte sind angenehmer; eine gute Akkulaufzeit reicht für mehrere Anwendungen."],
      ["Aufsätze", "Verschiedene Köpfe für grosse Muskeln, Gelenke oder gezielte Punkte erweitern den Nutzen."],
    ],
    faq: [
      ["Wofür eignet sich eine Massagepistole?", "Zur Lockerung verspannter Muskeln und zur Regeneration nach dem Sport. Bei Beschwerden oder Verletzungen vorher ärztlichen Rat einholen."],
      ["Worauf beim Kauf achten?", "Auf mehrere Intensitätsstufen, einen leisen Motor, ausreichend Akku und passende Aufsätze achten."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Eignung", "IPL wirkt am besten bei hellerer Haut und dunklen Haaren; auf die Hauttyp-Angaben des Herstellers achten."],
      ["Blitzzahl", "Eine hohe Zahl an Lichtimpulsen reicht für viele Anwendungen — wichtig für die Lebensdauer."],
      ["Fenster & Stufen", "Ein grösseres Lichtfenster behandelt schneller; mehrere Intensitätsstufen erhöhen den Komfort."],
    ],
    faq: [
      ["Für wen eignet sich IPL?", "Am besten für hellere Hauttöne mit dunklen Haaren. Bei sehr dunkler Haut oder hellen/grauen Haaren ist die Wirkung gering — die Herstellerangaben beachten."],
      ["Ist IPL dauerhaft?", "Es kann den Haarwuchs deutlich reduzieren, erfordert aber regelmässige Wiederholungen. Ergebnisse sind individuell verschieden."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Technik", "Düsenvernebler sind robust und günstig, Ultraschall- und Membranvernebler sind leiser und kompakter."],
      ["Zubehör", "Masken in Erwachsenen- und Kindergrösse sowie ein Mundstück gehören idealerweise dazu."],
      ["Reinigung", "Gut zu reinigende, teils auskochbare Teile sind aus Hygienegründen wichtig."],
    ],
    faq: [
      ["Welcher Inhalator-Typ ist gut?", "Düsenvernebler sind bewährt und günstig; Ultraschall- und Membrangeräte sind leiser und tragbarer. Bei medizinischem Bedarf ärztlichen Rat einholen."],
      ["Worauf bei Kindern achten?", "Auf eine passende Kindermaske und eine einfache, gut zu reinigende Handhabung achten."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Messart", "Kontaktthermometer gelten als sehr genau, Ohr- und Stirnthermometer messen schnell und berührungsarm."],
      ["Genauigkeit", "Auf eine zuverlässige Messung und eine klare Anzeige achten; bei Babys ist eine schnelle Messung praktisch."],
      ["Komfort", "Speicher, Fieberalarm und beleuchtetes Display erleichtern die Anwendung, auch nachts."],
    ],
    faq: [
      ["Welches Thermometer ist am genauesten?", "Kontaktthermometer (z. B. rektal bei Babys) gelten als am genauesten; Ohr- und Stirngeräte sind schneller und berührungsärmer, dafür etwas variabler."],
      ["Was ist für Babys gut?", "Eine schnelle, berührungsarme Messung ist angenehm — für sehr genaue Werte greifen viele bei Babys dennoch zum Kontaktthermometer."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Höhe & Stabilität", "Katzen klettern gern hoch — ein stabiler, kippsicherer Stand (ggf. Deckenfixierung) ist wichtig."],
      ["Ausstattung", "Liegemulden, Höhlen und Sisalstämme zum Kratzen sorgen für Beschäftigung."],
      ["Material", "Dicke Sisalwicklungen halten dem Kratzen lange stand; abnehmbare, waschbare Bezüge sind hygienisch."],
    ],
    faq: [
      ["Wie gross sollte der Katzenbaum sein?", "Möglichst hoch und stabil, damit die Katze klettern und von oben beobachten kann — die Grösse zum Raum und zur Katze passend wählen."],
      ["Worauf bei der Qualität achten?", "Auf einen kippsicheren Stand, dicke Sisalstämme und gut verarbeitete, am besten waschbare Bezüge achten."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Grösse", "Der Hund sollte sich ausgestreckt hinlegen können — die Liegelänge zur Körpergrösse passend wählen."],
      ["Material", "Orthopädische Betten mit festem Schaum entlasten Gelenke älterer Hunde; robuste Stoffe halten Krallen stand."],
      ["Reinigung", "Abnehmbare, waschbare Bezüge sind aus Hygienegründen sehr praktisch."],
    ],
    faq: [
      ["Welche Grösse braucht mein Hund?", "Miss deinen Hund im Liegen und gib etwas Reserve dazu — er sollte sich bequem ausstrecken können."],
      ["Was bringt ein orthopädisches Bett?", "Fester, formstabiler Schaum entlastet Gelenke und Wirbelsäule — besonders sinnvoll bei älteren oder grossen Hunden."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Grösse", "Der Hund muss stehen, sich drehen und liegen können — die Box nicht zu klein wählen."],
      ["Material", "Stabile Alu- oder Gitterboxen für den Kofferraum, faltbare Stoffboxen für drinnen und unterwegs."],
      ["Sicherheit", "Im Auto sollte die Box gut gesichert sein und in den Kofferraum passen — auf Crash-getestete Modelle achten."],
    ],
    faq: [
      ["Welche Grösse ist richtig?", "Der Hund sollte aufrecht stehen, sich umdrehen und ausgestreckt liegen können — lieber etwas grösser als zu eng."],
      ["Welche Box fürs Auto?", "Eine stabile, gut gesicherte Box (idealerweise crash-getestet), die in den Kofferraum passt, bietet im Auto den besten Schutz."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Grösse & Art", "Die Grösse richtet sich nach der Tierart — informiere dich vorher über die Mindestmasse für den jeweiligen Bewohner."],
      ["Belüftung & Heizung", "Gute Belüftung und die passende Wärme-/Lichttechnik sind für viele Arten lebenswichtig."],
      ["Material", "Glas und beschichtetes Holz sind verbreitet; eine sichere, gut zugängliche Tür erleichtert die Pflege."],
    ],
    faq: [
      ["Wie gross muss das Terrarium sein?", "Das hängt stark von der Tierart ab — informiere dich vor dem Kauf über die artgerechten Mindestmasse und die Klimaansprüche."],
      ["Was gehört zur Grundausstattung?", "Je nach Art Wärmequelle, geeignete Beleuchtung, Belüftung, Bodengrund und Verstecke — die Bedürfnisse des Tiers stehen im Vordergrund."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Portionierung", "Programmierbare Portionen und Zeiten sorgen für regelmässige Mahlzeiten — wichtig bei festen Fütterungszeiten."],
      ["Stromquelle", "Geräte mit Netz und Batterie-Backup füttern auch bei Stromausfall weiter."],
      ["Reinigung & Trockenfutter", "Spülbare Behälter sind hygienisch; die meisten Automaten sind für Trockenfutter gedacht."],
    ],
    faq: [
      ["Für welches Futter eignen sich Automaten?", "Die meisten sind für Trockenfutter ausgelegt; für Nassfutter gibt es spezielle Modelle mit Kühlung — die Angaben prüfen."],
      ["Was passiert bei Stromausfall?", "Geräte mit Batterie-Backup füttern weiter. Ohne Backup kann eine Mahlzeit ausfallen — das beim Kauf bedenken."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Innen oder Aussen", "Aussenkameras brauchen Wetterschutz (IP-Wert) und gutes Nachtbild; Innenkameras sind kompakter."],
      ["Speicher", "Lokale Speicherung (SD/Recorder) vermeidet laufende Cloud-Kosten; Cloud ist bequem, aber oft kostenpflichtig."],
      ["Datenschutz", "In der Schweiz darf man nur das eigene Grundstück filmen — öffentliche Bereiche oder Nachbargrundstücke sind tabu."],
    ],
    faq: [
      ["Was ist beim Datenschutz erlaubt?", "Du darfst nur dein eigenes Grundstück filmen. Gehweg, Strasse oder Nachbargrundstück aufzunehmen ist in der Regel nicht zulässig."],
      ["Cloud oder lokale Speicherung?", "Lokale Speicherung (SD-Karte/Recorder) spart laufende Kosten; Cloud ist komfortabel, aber meist abopflichtig — je nach Bedarf wählen."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Stromversorgung", "Akku-Modelle sind einfach zu montieren, kabelgebundene laufen dauerhaft ohne Laden."],
      ["Bild & Funktionen", "Gutes Weitwinkel- und Nachtbild, Bewegungserkennung und Gegensprechen sind nützlich."],
      ["Datenschutz", "Nur den eigenen Eingangsbereich erfassen; öffentliche Flächen und Nachbarn nicht dauerhaft filmen."],
    ],
    faq: [
      ["Akku oder Kabel?", "Akku-Türklingeln sind schnell montiert und brauchen kein Anschliessen; kabelgebundene laufen dauerhaft, ohne dass man den Akku laden muss."],
      ["Was ist datenschutzrechtlich zu beachten?", "Die Kamera sollte nur den eigenen Eingangsbereich erfassen — öffentliche Wege oder Nachbargrundstücke dauerhaft zu filmen ist heikel."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Steuerung", "Programmierbare Thermostate heizen nach Zeitplan; smarte Modelle lassen sich per App oder Sprachassistent regeln."],
      ["Passung", "Auf den passenden Ventilanschluss achten — oft liegen Adapter für gängige Ventile bei."],
      ["Sparpotenzial", "Absenken in ungenutzten Zeiten spart Energie; ein Fenster-offen-Erkennung vermeidet Heizen ins Leere."],
    ],
    faq: [
      ["Passt das Thermostat an meinen Heizkörper?", "Meist ja — viele Sets enthalten Adapter für gängige Ventile. Prüfe vor dem Kauf den Ventiltyp deines Heizkörpers."],
      ["Wie viel spart ein smartes Thermostat?", "Durch zeitgesteuertes Absenken lässt sich Energie sparen; wie viel, hängt von Nutzung und Gebäude ab. Wunderwerte sind unrealistisch."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Batterie", "Modelle mit fest verbauter Langzeitbatterie (bis 10 Jahre) ersparen den jährlichen Wechsel."],
      ["Vernetzung", "Vernetzte Melder lösen gemeinsam aus — sinnvoll in grösseren Wohnungen und über mehrere Stockwerke."],
      ["Norm & Platzierung", "Auf eine geprüfte Norm achten und Melder in Schlaf-/Wohnräumen und Fluren montieren."],
    ],
    faq: [
      ["Wo sollten Rauchmelder hängen?", "Mindestens in Schlafräumen, Kinderzimmern und Fluren, die als Fluchtweg dienen — an der Zimmerdecke, möglichst mittig."],
      ["Langzeitbatterie oder wechselbar?", "Fest verbaute 10-Jahres-Batterien sind wartungsarm; bei wechselbaren Batterien muss man regelmässig selbst tauschen."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Montage", "Viele Nachrüstschlösser werden innen auf den Zylinder gesetzt — ohne Bohren und meist mieterfreundlich."],
      ["Zugang", "App, Code, Fingerabdruck oder Funkschlüssel — mehrere Optionen sind praktisch für Familie und Gäste."],
      ["Sicherheit & Strom", "Auf eine gute Verschlüsselung und eine Notlösung bei leerem Akku (z. B. Schlüssel oder Powerbank) achten."],
    ],
    faq: [
      ["Kann ich das in einer Mietwohnung nutzen?", "Oft ja — viele Modelle werden innen auf den vorhandenen Zylinder montiert, ohne ihn auszutauschen. Im Zweifel mit der Verwaltung klären."],
      ["Was, wenn der Akku leer ist?", "Gute Schlösser warnen rechtzeitig und bieten eine Notöffnung (z. B. mechanischer Schlüssel oder externe Stromversorgung). Auf diese Option achten."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Tastenzahl", "61 Tasten reichen für den Einstieg; 76 oder 88 Tasten bieten mehr Spielraum für Fortgeschrittene."],
      ["Anschlag", "Anschlagdynamische Tasten reagieren auf die Spielstärke — das macht das Spiel ausdrucksvoller."],
      ["Funktionen", "Begleitautomatik, viele Klänge und Lernfunktionen motivieren Anfänger; Kopfhöreranschluss fürs leise Üben."],
    ],
    faq: [
      ["Wie viele Tasten brauche ich?", "Für den Einstieg reichen 61 Tasten; wer klassisch Klavier spielen möchte, fährt mit 88 gewichteten Tasten besser."],
      ["Keyboard oder E-Piano?", "Keyboards bieten viele Klänge und Begleitautomatik; E-Pianos ahmen das Klavierspiel mit gewichteten Tasten realistischer nach."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Bauart", "Konzertgitarren mit Nylonsaiten sind sanft zu den Fingern (gut für Einsteiger), Westerngitarren mit Stahlsaiten klingen brillanter."],
      ["Grösse", "Für Kinder und kleinere Personen gibt es 3/4- und 1/2-Grössen — eine passende Grösse erleichtert das Spielen."],
      ["Bespielbarkeit", "Eine niedrige Saitenlage und sauber verarbeitete Bünde machen das Üben angenehmer."],
    ],
    faq: [
      ["Nylon- oder Stahlsaiten für Anfänger?", "Nylonsaiten (Konzertgitarre) sind angenehmer für ungeübte Finger; Stahlsaiten (Western) klingen lauter und brillanter, drücken aber stärker."],
      ["Welche Grösse für Kinder?", "Je nach Alter und Körpergrösse eignen sich 1/2- oder 3/4-Gitarren — eine passende Grösse macht das Lernen leichter."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Einsteiger-Set", "Sets mit Verstärker, Kabel und Tasche sind für den Start praktisch und meist günstiger als Einzelkauf."],
      ["Tonabnehmer", "Single-Coils klingen klar und hell, Humbucker kräftiger und rockiger — je nach Musikstil wählen."],
      ["Bespielbarkeit", "Eine angenehme Saitenlage und ein sauber verarbeiteter Hals erleichtern das Üben."],
    ],
    faq: [
      ["Lohnt sich ein Einsteiger-Set?", "Für den Start ja — Set mit Verstärker und Zubehör ist günstiger und man hat sofort alles zum Loslegen."],
      ["Single-Coil oder Humbucker?", "Single-Coils klingen klar und brillant (Funk/Blues), Humbucker kräftiger und verzerrungsfreudiger (Rock/Metal) — der Stil entscheidet."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Grösse", "Sopran ist klein und klassisch, Konzert etwas grösser und fülliger, Tenor noch grösser mit mehr Platz für die Finger."],
      ["Material", "Massivholz klingt voller, Schichtholz ist günstiger und robust — für den Einstieg meist ausreichend."],
      ["Stimmstabilität", "Gute Mechaniken halten die Stimmung — wichtig, damit das Üben Spass macht."],
    ],
    faq: [
      ["Welche Ukulelen-Grösse für Anfänger?", "Sopran und Konzert sind beliebte Einsteigergrössen; wer grössere Hände hat, fühlt sich mit Konzert oder Tenor oft wohler."],
      ["Massiv- oder Schichtholz?", "Schichtholz ist günstig und robust und reicht zum Lernen; Massivholz klingt voller und ist eher etwas für Fortgeschrittene."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Anschluss", "USB-Mikrofone sind sofort einsatzbereit, XLR-Mikrofone brauchen ein Interface, bieten aber mehr Flexibilität."],
      ["Richtcharakteristik", "Nieren-Mikrofone nehmen vor allem von vorne auf — gut, um Raumgeräusche zu reduzieren."],
      ["Zubehör", "Popschutz und ein stabiler Ständer oder Arm verbessern die Aufnahme spürbar."],
    ],
    faq: [
      ["USB oder XLR?", "USB ist am einfachsten und ideal für den Einstieg; XLR mit Interface bietet bessere Klangqualität und mehr Erweiterungsmöglichkeiten."],
      ["Was verbessert die Aufnahme am meisten?", "Neben dem Mikrofon helfen ein Popschutz, ein ruhiger Raum und der richtige Abstand zum Mikrofon am meisten."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Technik", "FDM-Drucker (Filament) sind günstig und vielseitig, Resin-Drucker liefern feine Details, brauchen aber mehr Nachbearbeitung."],
      ["Bauraum", "Der nutzbare Druckraum bestimmt die maximale Objektgrösse — nach Bedarf wählen."],
      ["Bedienung", "Auto-Leveling und eine gute Software erleichtern den Einstieg; bei Resin auf Schutz und Belüftung achten."],
    ],
    faq: [
      ["FDM oder Resin für Einsteiger?", "FDM ist günstiger, einfacher und sauberer — ideal zum Lernen. Resin liefert feinere Details, ist aber aufwendiger und erfordert Schutzmassnahmen."],
      ["Was kostet das Material?", "Filament ist relativ günstig pro Kilo; Resin ist teurer. Die Materialkosten pro Objekt sind aber meist überschaubar."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Mit oder ohne Display", "Tablets ohne Display sind günstig (man schaut auf den Monitor); Display-Tablets zeichnen direkt auf dem Bildschirm."],
      ["Drucksensitivität", "Mehr Druckstufen erlauben feinere Strichstärken — wichtig für Illustration und Retusche."],
      ["Fläche", "Eine grössere aktive Fläche gibt mehr Bewegungsfreiheit; für unterwegs reicht ein kompaktes Modell."],
    ],
    faq: [
      ["Mit Display oder ohne?", "Ohne Display ist günstiger und reicht zum Lernen; mit Display zeichnet man direkt aufs Bild, was intuitiver ist, aber mehr kostet."],
      ["Wie wichtig ist die Drucksensitivität?", "Für Zeichnen und Retusche sehr wichtig — mehr Druckstufen erlauben feinere Übergänge und natürlichere Striche."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Schnittart", "Partikelschnitt (Cross-Cut) ist sicherer als Streifenschnitt — wichtig bei sensiblen Daten."],
      ["Sicherheitsstufe", "Höhere Sicherheitsstufen (DIN-Level) zerkleinern feiner; für private Post reicht meist eine mittlere Stufe."],
      ["Kapazität", "Blattzahl pro Durchgang und Auffangbehälter-Grösse zur Nutzung passend wählen; CD-/Kartenschnitt ist ein Plus."],
    ],
    faq: [
      ["Streifen- oder Partikelschnitt?", "Partikelschnitt (Cross-Cut) ist deutlich sicherer, weil die Schnipsel kleiner sind — bei sensiblen Daten klar zu bevorzugen."],
      ["Welche Sicherheitsstufe brauche ich?", "Für normale private Unterlagen reicht eine mittlere Stufe; für sehr vertrauliche Daten eine höhere DIN-Sicherheitsstufe wählen."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Standalone oder PC", "Standalone-Headsets laufen ohne PC und sind unkompliziert; PC-VR bietet mehr Grafikleistung, braucht aber einen starken Rechner."],
      ["Auflösung & Tracking", "Höhere Auflösung wirkt schärfer; gutes Tracking sorgt für präzise Bewegungen."],
      ["Komfort", "Gewicht, Polsterung und einstellbarer Augenabstand sind wichtig für längere Sessions."],
    ],
    faq: [
      ["Brauche ich einen PC?", "Standalone-Brillen funktionieren eigenständig ohne PC; für grafisch aufwendige PC-VR-Spiele ist ein leistungsstarker Computer nötig."],
      ["Wird mir bei VR schlecht?", "Manche reagieren empfindlich (Motion Sickness). Gutes Tracking, hohe Bildraten und langsames Herantasten helfen, das zu vermeiden."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Kamera & Flugzeit", "Höhere Kameraauflösung und eine stabile Bildstabilisierung verbessern Aufnahmen; längere Flugzeit gibt mehr Spielraum."],
      ["Gewicht & Regeln", "In der Schweiz/EU gelten Drohnenregeln (Registrierung, Kennzeichnung ab bestimmten Gewichten) — vor dem Flug informieren."],
      ["Einsteiger", "Für den Start sind kleine, stabile Drohnen mit Hindernis-Sensoren und einfacher Steuerung gut geeignet."],
    ],
    faq: [
      ["Welche Regeln gelten in der Schweiz?", "Je nach Gewicht und Einsatz gelten Registrierungs- und Kennzeichnungspflichten sowie Abstands- und Flugverbotszonen. Vor dem Kauf/Flug die aktuellen Vorgaben prüfen."],
      ["Welche Drohne für Einsteiger?", "Eine kleine, stabile Drohne mit Hindernis-Erkennung und einfacher App-Steuerung erleichtert den Start und verzeiht Anfängerfehler."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Akku & Laufzeit", "Die Akkulaufzeit sollte für mehrere Fenster reichen; austauschbare Akkus verlängern die Arbeitszeit."],
      ["Düsenbreite", "Breite Düsen für grosse Scheiben, schmale für Sprossenfenster — manche Sets enthalten beides."],
      ["Tank & Komfort", "Ein leicht entleerbarer Schmutzwassertank und geringes Gewicht erleichtern die Arbeit."],
    ],
    faq: [
      ["Lohnt sich ein Fenstersauger?", "Wenn du oft Fenster putzt: ja — er nimmt das Schmutzwasser auf und vermeidet Streifen und Tropfen auf der Fensterbank."],
      ["Worauf beim Kauf achten?", "Auf eine ausreichende Akkulaufzeit, eine passende Düsenbreite und einen einfach zu entleerenden Tank achten."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Kühlleistung", "Die Leistung (BTU/kW) zur Raumgrösse passend wählen — ein zu schwaches Gerät kühlt kaum."],
      ["Abluft", "Monoblock-Geräte brauchen einen Abluftschlauch nach draussen; eine gute Fensterabdichtung erhöht die Wirkung."],
      ["Lautstärke & Energie", "Auf den Geräuschpegel und die Energieeffizienz achten — beides macht sich im Alltag bemerkbar."],
    ],
    faq: [
      ["Wie stark muss das Gerät sein?", "Die Kühlleistung (BTU/kW) richtet sich nach der Raumgrösse — eine grobe Faustregel und die Herstellerangaben helfen bei der Auswahl."],
      ["Braucht es einen Abluftschlauch?", "Ja, mobile Monoblock-Klimageräte leiten warme Luft über einen Schlauch nach draussen — ohne gute Fensterabdichtung sinkt die Wirkung deutlich."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Technik", "Wärmepumpentrockner sind sparsam im Stromverbrauch, Kondenstrockner günstiger in der Anschaffung."],
      ["Effizienz", "Auf eine gute Energieeffizienzklasse achten — sie senkt die laufenden Kosten spürbar."],
      ["Fassung", "Das Fassungsvermögen (kg) zur Haushaltsgrösse passend wählen; Sensorprogramme vermeiden Übertrocknen."],
    ],
    faq: [
      ["Wärmepumpe oder Kondenstrockner?", "Wärmepumpentrockner verbrauchen deutlich weniger Strom (günstiger im Betrieb), kosten aber mehr in der Anschaffung als Kondenstrockner."],
      ["Welche Grösse brauche ich?", "Das Fassungsvermögen sollte zur Wäschemenge passen — für Familien grössere Trommeln, für kleine Haushalte reichen kompakte Geräte."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Saugkraft", "Genug Leistung für Krümel und Tierhaare; ein gut zugänglicher Filter erleichtert die Reinigung."],
      ["Akku", "Auf eine ausreichende Laufzeit und kurze Ladezeit achten — für kleine Einsätze reicht meist wenig."],
      ["Zubehör", "Fugendüse und Bürstenaufsatz erreichen Polster, Auto und Ritzen."],
    ],
    faq: [
      ["Handstaubsauger oder Akku-Stielsauger?", "Handsauger sind kompakt für kleine Einsätze (Auto, Krümel); Stielsauger ersetzen eher den klassischen Bodenstaubsauger."],
      ["Worauf bei der Reinigung achten?", "Auf einen leicht entleerbaren Staubbehälter und einen auswaschbaren Filter achten — das spart Folgekosten."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Vielseitigkeit", "Diese Sauger nehmen Staub und Flüssigkeiten auf — ideal für Werkstatt, Garage und Keller."],
      ["Behälter", "Ein grösserer Behälter muss seltener geleert werden; eine Blasfunktion ist ein praktisches Extra."],
      ["Zubehör & Filter", "Verschiedene Düsen und ein passender Filter (für Nass/Trocken) erweitern den Einsatz."],
    ],
    faq: [
      ["Wofür eignet sich ein Nass-Trockensauger?", "Für gröbere Arbeiten in Werkstatt, Garage oder Keller — er saugt sowohl Staub und Späne als auch Wasser auf."],
      ["Kann er einen Haushaltsstaubsauger ersetzen?", "Für die feine Wohnungsreinigung ist ein normaler Staubsauger meist angenehmer; der Nass-Trockensauger glänzt bei groben und feuchten Einsätzen."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Navigation", "Laser-/Kameranavigation fährt systematisch und kartiert die Wohnung; einfache Modelle fahren eher zufällig."],
      ["Wischfunktion", "Manche wischen nur feucht, bessere mit Anpressdruck und automatischer Moppreinigung."],
      ["App & Absturzsicherung", "Zeitpläne, Raumkarten und eine zuverlässige Absturz-/Hinderniserkennung sind im Alltag praktisch."],
    ],
    faq: [
      ["Saugen und Wischen in einem Gerät?", "Viele Modelle können beides; das Wischen ersetzt aber kein gründliches Schrubben hartnäckiger Flecken — für den Alltag ist es eine grosse Hilfe."],
      ["Lohnt sich die Laser-Navigation?", "Ja, sie reinigt systematischer und gründlicher als Zufallsfahrer und erlaubt Raumkarten und gezielte Reinigung per App."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Einsatzort", "Tischgrills sind ideal für Balkon und drinnen (rauchärmer), Standgrills bieten mehr Fläche für den Garten."],
      ["Leistung", "Mehr Watt sorgt für höhere Grilltemperaturen und schnelleres Aufheizen."],
      ["Reinigung", "Herausnehmbare, spülmaschinenfeste Grillplatten und eine Fettauffangschale erleichtern das Saubermachen."],
    ],
    faq: [
      ["Elektrogrill auf dem Balkon erlaubt?", "Elektrogrills sind rauchärmer und daher auf Balkonen oft eher zulässig als Kohlegrills — die Hausordnung und Rücksicht auf Nachbarn beachten."],
      ["Worauf bei der Leistung achten?", "Mehr Watt bedeutet höhere Temperaturen und schnelleres Aufheizen — wichtig für ein gutes Grillergebnis bei Fleisch."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Typ", "Elektrische Aufschäumer können oft heiss und kalt schäumen; Handgeräte und Stabaufschäumer sind günstig und kompakt."],
      ["Funktion", "Modelle mit Heiz- und Schäumfunktion bereiten Latte und Cappuccino in einem Schritt zu."],
      ["Reinigung", "Antihaftbeschichtungen und spülbare Teile erleichtern das Sauberhalten."],
    ],
    faq: [
      ["Elektrisch oder manuell?", "Elektrische Geräte schäumen und erhitzen die Milch automatisch; Hand-/Stabaufschäumer sind günstig und platzsparend, brauchen aber separat heisse Milch."],
      ["Welche Milch schäumt am besten?", "Frische Milch mit etwas höherem Eiweissgehalt schäumt meist gut; viele pflanzliche Drinks (z. B. Barista-Varianten) funktionieren ebenfalls."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
  {
    ...
    tips: [
      ["Kapazität", "Die Zahl der Eier pro Durchgang nach Haushalt wählen; für Familien lohnen grössere Modelle."],
      ["Härtegrad", "Eine Einstellung für weich/mittel/hart und ein Signalton sorgen für gleichmässige Ergebnisse."],
      ["Extras & Reinigung", "Pochier- und Omeletteinsätze erweitern den Nutzen; abnehmbare Teile sind leicht zu reinigen."],
    ],
    faq: [
      ["Lohnt sich ein Eierkocher?", "Wenn du regelmässig Eier kochst: ja — er gart sie gleichmässig auf den gewünschten Härtegrad und braucht weniger Wasser als ein Topf."],
      ["Wie wird der Härtegrad eingestellt?", "Meist über die Wassermenge und/oder einen Regler. Ein Signalton meldet, wenn die Eier fertig sind."],
      ["Wo finde ich Angebote?", "Über die Angebote-Suche nach Preis filtern und Modelle vergleichen."],
    ],
  },
  {
    ...
    tips: [
      ["Plattenform", "Dreiecksplatten schneiden und versiegeln das Sandwich; flache Platten eignen sich auch für Panini."],
      ["Wechselplatten", "Geräte mit wechselbaren Platten (Sandwich, Waffel, Grill) sind vielseitiger."],
      ["Reinigung", "Antihaftbeschichtete, herausnehmbare Platten lassen sich am einfachsten reinigen."],
    ],
    faq: [
      ["Welche Plattenform ist besser?", "Dreiecksplatten versiegeln die Ränder (Füllung bleibt drin); flache Platten sind vielseitiger und auch für Panini geeignet."],
      ["Lohnen sich Wechselplatten?", "Wenn du Abwechslung willst, ja — ein Gerät mit Sandwich-, Waffel- und Grillplatten ersetzt mehrere Küchengeräte."],
      ["Wo vergleichen?", "In der Angebote-Suche nach Preis filtern und Modelle gegenüberstellen."],
    ],
  },
];
