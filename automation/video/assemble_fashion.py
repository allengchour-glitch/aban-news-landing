...
HERE="/home/user/aban-news-landing"; SEG="/tmp/fash/seg"; os.makedirs(SEG,exist_ok=True)
F="/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf"
NODE="/opt/node22/bin/node"
ids=json.load(open("/tmp/fash_ids.json"))  # [{id,label,price}] in clip order c0..c3
...
out=f"{HERE}/reels/luxe-fashion-motion.mp4"
