...
def wrap(draw, text, fnt, maxw, maxlines=2):
    ...
    lines.append(cur)
    # Falls Rest übrig: in letzte Zeile gekürzt
...
def render_card(product_img, label, width, height):
    ...
    # vertikale Position: Block + Pill sitzen unten
...
def main():
    ...
    # ONLY-Modus: bestehende Bilder neu rendern, Queue/Pointer unberührt.
    if ONLY:
