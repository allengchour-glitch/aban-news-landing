...
const REPLIES = {
  versand: [
    'Hey! 🤍 Wir liefern in die ganze Schweiz – Gratis-Versand ab CHF 49. Alle Infos auf luxestyle.ch ✨',
    'Hi! 📦 Schweizweiter Versand, gratis ab CHF 49. Mehr dazu auf luxestyle.ch 🇨🇭',
  ],
  groesse: [
