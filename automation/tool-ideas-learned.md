# 🧠 Tool-Ideen-Learnings — Backlog für den autonomen Loop (auto-generiert)
...
- **P3** `schlafphasen-wecker.html` — **Powernap-Timer**: Ideale Kurzschlaf-Dauer (10/20/90 Min) — Wecker-Zeit
- **P3** `trinkgeld-rechner.html` — **Trinkgeld-Rechner**: Trinkgeld & Aufrunden, pro Person teilen
- **P3** `waehrung-cheatsheet.html` — **Reise-Budget-Rechner**: Tagesbudget & Gesamtkosten einer Reise (ohne Live-Kurse)
