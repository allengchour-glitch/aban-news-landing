...
PLAN = [
    ...
    # 23.09. abends — Keywordplan (dropship/KEYWORDPLAN-2026-09.md, Abschnitt C): Hauptkeyword des Clusters fehlte im SEO-Titel,
    # Kollektion >= 20 aktive (GEMESSEN productsCount collection_id+status:active, limit:null, EXACT); Altwerte = Live-Stand 23.09. 23:30 UTC
    ("katzenwelt", "seo_t", "voll",
     "Katzenwelt kaufen Schweiz | LuxeStyle",
     "Katzenspielzeug, Kratzbaum & Katzenzubehör kaufen | LuxeStyle"),
    ("katzenwelt", "seo_d", "voll",
     "Alles für deine Katze: Spielzeug, Kratzbäume, Näpfe, Pflege und Zubehör.",
     "Alles für deine Katze: Katzenspielzeug, Kratzbäume, Katzenbetten, Näpfe und Pflege bei LuxeStyle Schweiz. Gratis-Versand ab CHF 50, 30 Tage Rückgabe."),
    ("hundewelt", "seo_t", "voll",
     "Hundewelt kaufen Schweiz | LuxeStyle",
     "Hundebett, Hundeleine & Hundegeschirr kaufen | LuxeStyle CH"),
    ("hundewelt", "seo_d", "voll",
     "Alles für deinen Hund: Spielzeug, Leinen, Betten, Näpfe, Pflege und mehr.",
     "Alles für deinen Hund: Hundebetten, Hundeleinen, Hundegeschirre, Spielzeug, Näpfe und Pflege bei LuxeStyle Schweiz. Gratis-Versand ab CHF 50."),
    ("tierspielzeug", "seo_t", "voll",
     "Tierspielzeug kaufen | LuxeStyle Schweiz",
     "Katzenspielzeug & Hundespielzeug kaufen | LuxeStyle Schweiz"),
    ("tierspielzeug", "seo_d", "voll",
     "Beschäftigung für Hund und Katze: Intelligenzspielzeug, Laser, Bälle und interaktive Spielsachen gegen Langeweile.",
     "Katzenspielzeug und Hundespielzeug gegen Langeweile: Intelligenzspielzeug, Laser, Bälle und interaktive Spielsachen. Gratis-Versand ab CHF 50."),
    ("schuhe-sneaker", "seo_t", "voll",
     "Sneaker kaufen | LuxeStyle",
     "Sneaker Damen & Herren kaufen | LuxeStyle Schweiz"),
    ("schuhe-sneaker", "seo_d", "voll",
     "Sneaker online bei LuxeStyle – Gratis-Versand ab CHF 50.",
     "Sneaker für Damen und Herren online kaufen: Turnschuhe, Laufschuhe und Sportschuhe für Alltag und Sport. Gratis-Versand ab CHF 50, 30 Tage Rückgabe."),
    ("herren-uhren", "seo_t", "voll",
     "Herren-Uhren kaufen | LuxeStyle Schweiz",
     "Herrenuhren online kaufen | LuxeStyle Schweiz"),
    ("herren-uhren", "seo_d", "voll",
     "Herren-Uhren online: Marken & Designs. Schweizer Shop, gratis Versand ab CHF 50, 30 Tage Rückgabe.",
     "Herrenuhren online kaufen: sportliche, elegante und klassische Modelle für jeden Anlass bei LuxeStyle Schweiz. Gratis-Versand ab CHF 50, 30 Tage Rückgabe."),
    ("haarstyling-geraete", "seo_t", "voll",
     "Haarstyling-Geräte kaufen Schweiz | LuxeStyle",
     "Lockenstab, Glätteisen & Haarstyling-Geräte | LuxeStyle CH"),
    ("haarstyling-geraete", "seo_d", "voll",
     "Haartrockner, Glätteisen und Lockenstäbe — Salon-Styling für zuhause.",
     "Lockenstäbe, Glätteisen, Haartrockner und Warmluftbürsten für Salon-Styling zuhause. Gratis-Versand ab CHF 50, 30 Tage Rückgabe."),
    ("tastatur-maus", "seo_t", "voll",
     "Tastaturen & Mäuse kaufen Schweiz | LuxeStyle",
     "Gaming-Tastatur & Gaming-Maus kaufen | LuxeStyle Schweiz"),
    ("tastatur-maus", "seo_d", "voll",
     "Tastaturen, Gaming-Mäuse und Mauspads für Büro und Gaming.",
     "Gaming-Tastaturen, Gaming-Mäuse, kabellose Mäuse und Mauspads für Büro und Gaming. Gratis-Versand ab CHF 50, 30 Tage Rückgabe."),
    ("kopfhoerer-audio", "seo_t", "voll",
     "Kopfhörer & Audio kaufen | LuxeStyle Schweiz",
     "Bluetooth-Kopfhörer & Audio kaufen | LuxeStyle Schweiz"),
    ("kopfhoerer-audio", "seo_d", "voll",
     "Kopfhörer & Audio online kaufen bei LuxeStyle: grosse Auswahl, Gratis-Versand ab CHF 50, 30 Tage Rückgabe, Lieferzeit auf jeder Produktseite.",
     "Bluetooth-Kopfhörer, Earbuds, Headsets und Lautsprecher online kaufen. Gratis-Versand ab CHF 50, 30 Tage Rückgabe, Lieferzeit auf jeder Produktseite."),
    ("yoga-pilates", "seo_t", "voll",
     "Yoga & Pilates kaufen | LuxeStyle Schweiz",
     "Yogamatte & Yoga-Zubehör kaufen | LuxeStyle Schweiz"),
    ("yoga-pilates", "seo_d", "voll",
     "Yoga & Pilates online kaufen bei LuxeStyle: grosse Auswahl, Gratis-Versand ab CHF 50, 30 Tage Rückgabe, Lieferzeit auf jeder Produktseite.",
     "Yogamatten und Zubehör für Yoga und Pilates zuhause. Gratis-Versand ab CHF 50, 30 Tage Rückgabe, Lieferzeit auf jeder Produktseite."),
    ("ft-pluesch", "seo_t", "voll",
     "🧸 Plüschtiere | LuxeStyle",
     "Plüschtiere & Kuscheltiere kaufen | LuxeStyle Schweiz"),
    ("ft-pluesch", "seo_d", "voll",
     "Kuschelige Plüschtiere – schnelle Lieferung aus der Schweiz.",
     "Plüschtiere und Kuscheltiere: Bären, Hunde, Katzen und Plüsch-Kissen – vieles ab Schweizer Lager in 1–2 Werktagen. Gratis-Versand ab CHF 50."),
    ("kissen-wohntextilien", "seo_t", "voll",
     "Kissen & Wohntextilien online kaufen | LuxeStyle",
     "Zierkissen, Vorhänge & Wohntextilien kaufen | LuxeStyle"),
    ("kissen-wohntextilien", "seo_d", "voll",
     "Zierkissen, Kissenbezüge, Überwürfe & Vorhänge für ein gemütliches Zuhause. Grosse Auswahl bei LuxeStyle – Schweizer Shop, versandkostenfrei ab CHF 50.",
     "Zierkissen, Kissenbezüge, Überwürfe und Vorhänge für ein gemütliches Zuhause bei LuxeStyle Schweiz. Gratis-Versand ab CHF 50, 30 Tage Rückgabe."),
    ("herren-hemden", "seo_t", "voll",
     "Herren-Hemden – Sommer- & Businesshemden | LuxeStyle CH",
     "Herren-Hemden & Leinenhemden kaufen | LuxeStyle Schweiz"),
    ("herren-hemden", "seo_d", "voll",
     "Herren-Hemden bei LuxeStyle Schweiz: Sommer-, Leinen- & Businesshemden. Schnelle Lieferung, 30 Tage Rückgabe, −10% mit Code WELCOME10.",
     "Herren-Hemden bei LuxeStyle Schweiz: Leinenhemden, Sommerhemden und Businesshemden für Freizeit und Büro. Gratis-Versand ab CHF 50, 30 Tage Rückgabe."),
]
