...
const NICHE={
  ...
  anime:{coll:{handle:'anime-manga',title:'🎌 Anime & Manga',tag:'anime'},type:'Anime',tags:['anime','geschenk','hype-2026','sammler'],
    kw:['anime action figure','naruto figure','one piece figure','dragon ball figure','demon slayer figure','anime keychain','anime acrylic stand'],
    must:['anime','manga','naruto','one piece','dragon ball','demon slayer','goku','luffy','action figure'],
    ban:['dress','kleid','jumpsuit','top','pants','hose','bodysuit','shapewear','clothing','skirt','rock','lingerie','bra','swimwear','figure-','flattering','tummy']},
  fishing:{coll:{handle:'angeln',title:'🎣 Angeln',tag:'angeln'},type:'Angelsport',tags:['angeln','outdoor','hobby'],
    ...
    ban:['chair','stuhl','hat','cap','hut','umbrella','schirm','tent','zelt','sunglasses','glasses','brille','clothing','shirt','jacket','shoe','boot']},
  tauchen:{coll:{handle:'tauchen-schnorcheln',title:'🤿 Tauchen & Schnorcheln',tag:'tauchen'},type:'Wassersport',tags:['tauchen','wassersport','sommer'],
    kw:['snorkel set','diving mask snorkel','swim fins flippers','swimming goggles anti fog','freediving mask'],
    must:['snorkel','diving mask','diving fins','swim fins','swimming goggles','freediving','scuba','flippers'],
    ban:['sleep','eye mask','eye ','collagen','retinol','cream','face','serum','augen','schlaf']},
  metalldetektor:{coll:{handle:'metalldetektoren-schatzsuche',title:'🔍 Metalldetektoren & Schatzsuche',tag:'metalldetektor'},type:'Metalldetektor',tags:['metalldetektor','outdoor','hobby','schatzsuche'],
    kw:['metal detector','gold metal detector','treasure hunting metal detector','pinpointer metal detector'],
    must:['metal detector','gold detector','treasure','pinpointer'],
    ban:['smoke','co ','carbon','gas','leak','fire','rauch','stud','wall','voltage','cable','water leak','radar']},
  velo:{coll:{handle:'velo-radsport',title:'🚲 Velo & Radsport',tag:'velo'},type:'Radsport',tags:['velo','fahrrad','sport','outdoor'],
    kw:['bicycle light','bike phone holder','bike pump','bike repair tool','bicycle bell','bike chain cleaner'],
    must:['bicycle','bike ','cycling'],ban:['kids','toy','child','decoration','wall','jewelry','schmuck','necklace','pendant','jewellery']},
