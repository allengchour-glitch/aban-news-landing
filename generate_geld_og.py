...
PAGES = [
 ("geld-und-ki", "GELD & KI", "Ohne Hype", "Maerkte, ETF, Krypto, Steuer, Vorsorge", "Rechner & Checks - keine Anlageberatung",
 ...
 ("krypto-fuer-einsteiger", "KRYPTO", "Fuer Einsteiger", "Bitcoin & Co.: Kauf, Risiken, Schutz", "Einfach erklaert - keine Anlageberatung",
                 "CRYPTO", "For beginners", "Bitcoin & co.: buying, risks, safety", "Plain language - not advice"),
 ("etf-fuer-einsteiger", "ETF", "Fuer Einsteiger", "Der ruhige Weg + Kostenrechner", "Anti-Hype - keine Anlageberatung",
 ...
 ("steuer-basics-selbststaendige", "STEUER-BASICS", "Selbststaendige", "Steuern, Ruecklage, Belege, Fristen", "Einfach erklaert - keine Steuerberatung",
 ...
 ("altersvorsorge-selbststaendige", "ALTERSVORSORGE", "Selbststaendige", "Ehrlich vorsorgen + Rechner", "Keine Anlageberatung",
