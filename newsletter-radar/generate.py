#!/usr/bin/env python3
"""Newsletter-Radar — static site generator (German, DACH-Fokus).

Reads the curated newsletter/email-marketing-tool database (data/anbieter.json)
...
Structurally modelled on dropshipping-radar/generate.py: same brand tokens, the
...
du-Form — E-Mail-Marketing ist hype-lastig, hier wird ehrlich verglichen.
...
SITE_NAME = "Newsletter-Radar"
BASE_URL = "https://newsletter.abannews.com"
LANG = "de"
...
UI = {
    "tagline": "Newsletter- & E-Mail-Marketing-Tools, ehrlich verglichen — für den DACH-Raum",
    "all_tools": "← Alle Tools",
    "categories": "Kategorien",
    "focuses": "Schwerpunkt",
    "home_heading": "{n} Newsletter- & E-Mail-Tools im Überblick",
    "provider": "Anbieter",
    "type": "Typ",
    "focus": "Schwerpunkt",
    "language": "Sprache",
    ...
    "best_in": "Beste Newsletter-Tools: {cat}",
    "focus_page": "Newsletter-Tools: {foc}",
    "privacy": "Datenschutz",
    "imprint": "Impressum",
    ...
    "honest": ("Ehrlich vorab: Ein Newsletter-Tool macht noch keinen guten Newsletter. "
               "Inhalt, Liste und Versandrhythmus liegen bei dir. Rechtspflichten "
               "(Double-Opt-in, Impressum, Abmeldelink, Auftragsverarbeitung nach DSGVO) "
...
FAVICON_SVG = (
    ...
    '<rect x="12" y="18" width="40" height="28" rx="4" fill="none" stroke="#fff" '
    'stroke-width="3" stroke-linejoin="round"/>'
    '<path d="M13 20 32 34 51 20" fill="none" stroke="#fff" stroke-width="3" '
...
def faq_section(tool):
    ...
    qa.append((f"Hostet {name} in der EU (DSGVO-relevant)?",
               {"ja": "Ja, laut Anbieter gibt es EU-Hosting bzw. EU-Datenverarbeitung — das erleichtert die DSGVO-Konformität.",
...
LEGAL_DOMAIN = "newsletter.abannews.com"
...
beim E-Mail-Marketing (z. B. Double-Opt-in, Impressum, Abmeldelink, Auftragsverarbeitung nach
Art. 28 DSGVO, ggf. Drittlandtransfer) liegen beim Versender.</p>
...
def notfound_page():
    body = (f'<h1>📬 404 — Seite nicht gefunden</h1>\n'
            f'<p class="meta">Diese Seite gibt es nicht. Zurück zur Übersicht aller Newsletter- & E-Mail-Tools.</p>\n'
...
SEARCH_JS = """// Newsletter-Radar — client-side filter (no deps, no tracking)
(function () {
...
def main():
    ...
    ap = argparse.ArgumentParser(description="Newsletter-Radar generator")
