...
- **🔧 AUTONOME SELBSTHEILUNG (`/tmp/clean_images.mjs`):** pro DRAFT-Produkt jedes Bild geprüft → schlechte (Watermark/Schrift/Vorher-Nachher) **gelöscht**, saubere behalten → **35 wieder ACTIVE** (z.B. Herren-Hemd 18 saubere Bilder, French Press 6). **Nur 5 bleiben DRAFT** (alle Bilder schlecht: LED-Spiegelwecker, Shiatsu-Nackenkissen, Lost Nomade, Angel's Love, Knet-Set Jovi) → brauchen echtes Ersatzbild.
