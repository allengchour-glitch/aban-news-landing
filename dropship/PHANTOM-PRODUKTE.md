# Phantom-Produkte in Ratgebern — Arbeitsstand 02.09.2026

Der Generator-Lauf vom 29.05. hat in **28 Artikeln** Produkte mit NAMEN und PREIS beworben,
die es nie gab — die Links zeigen auf KOLLEKTIONEN. Befundliste (Scan 02.09.):
`dropship/_phantom_befunde_0209.txt`. Scanner: Kollektionslink + `für CHF X`/`(CHF X)` im
Umfeld von 120 Zeichen danach.

## Erledigt (je vollständig, Rückfeld 0 Alt-Namen)
...
|---|---|---|---|
| Himalaya Salzkristall-Lampe (24.90, «handgeschnitzt») | UFO Kristall-Salzlampe | 24.90 | ufo-kristall-salzlampe-900a8e |
| Soja-Duftkerzen 4er-Set (19.90) | Duftkerze im Aluminiumgehäuse | 15.90 | duftkerze-im-aluminiumgehause-601100 |
...
| ANC In-Ear (49.90) | In-Ear Bluetooth-Kopfhörer mit ANC | 52.90 | in-ear-bluetooth-kopfhorer-mit-anc-635800 |

## Ohne Gegenstück → GENERISCH machen (Preis + Produktname streichen, ehrliches Kategorielabel)
HEPA Luftreiniger Smart (nur Auto-Geräte aktiv) · Pillow Spray Premium Lavendel ·
Herren-Lederarmband Edelstahl-Anker · minimalistische Herren-Halskette (Fenrir ist DRAFT) ·
Bambus-Picknick-Set (Kochset ≠ Geschirr) · Wellness-Bambus-Tablett · Akupressur-Matte
Premium Set (DRAFT-Klasse 28.08.) · Recovery-Set Premium (DRAFT) · Ätherische-Öle-6er-Set
solo (nur im Bundle) · Gesichtsmasken-7-Tage-Set · Muttertag-Box.

## Regeln (aus den drei erledigten gelernt)
1. **Satz-Chirurgie, nie nur der Link:** Der Folgetext beschreibt oft den Phantom-INHALT
   («vereint Jade Roller, Seiden-Kissenbezug…», «6 mm Polsterung», «Noten Rose und Lavendel»)
   und muss auf die echten Eigenschaften umgeschrieben werden — nur Behauptungen, die der
   PRODUKTTEXT des Ziels deckt.
2. **FAQ und Folgeabsätze mitprüfen:** Phantome tauchen ohne Link wieder auf («aus dem Set»,
