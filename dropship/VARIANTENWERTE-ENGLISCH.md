...
> Werkzeug: `automation/variant_value_clean.py` (täglich im Aufseher). Durchgang seit 2026-09-23 17:49 UTC, Stand 2026-09-23 19:12 UTC — **läuft noch (Zahlen sind Zwischenstand)**.

> Übersetzt wird nur, wenn JEDES Wort eines Werts bekannt ist (farben_de.json, Farbkomposition, Begriffstabellen im Skript). Alles andere bleibt stehen und erscheint unten. Jede Umbenennung steht Wert für Wert in `dropship/_variant_value_clean_en.txt` (alt → neu, rückgängig machbar).

## Zahlen

- Produkte gesehen: **25'810**
- Optionen mit englischen Werten (Kandidaten): 3'492
- Optionen übersetzt: **1'886** · Werte übersetzt: **12'406**
- Optionen nur codebereinigt: 0
- Werte mit unbekanntem Wort (unverändert): 11'982
...
`light` 434, `inner` 369, `color` 308, `shell` 162, `degrees` 159, `core` 137, `surface` 124, `no` 110, `powder` 110, `diamond` 108, `high` 101, `skin` 98, `three` 97, `to` 96, `bag` 91, `rain` 88, `case` 87, `french` 84, `opp` 81, `belt` 79, `four` 78, `rope` 70, `base` 69, `dual` 69, `dark` 68, `petal` 68, `chain` 67, `half` 63, `feet` 62, `size` 62, `mother` 61, `tea` 60, `of` 60, `code` 59, `buckle` 58, `net` 57, `plush` 56, `one` 55, `electric` 55, `little` 54, `strap` 53, `face` 52, `line` 52, `person` 51, `fold` 51, `lens` 50, `bear` 49, `ice` 48, `suit` 48, `space` 48, `night` 47, `hat` 47, `cloud` 47, `cat` 46, `sheet` 46, `for` 46, `about` 46, `warped` 46, `milk` 45, `star` 45
