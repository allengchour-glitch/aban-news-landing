...
> Werkzeug: `automation/variant_value_clean.py` (täglich im Aufseher). Durchgang seit 2026-09-23 17:49 UTC, Stand 2026-09-23 19:07 UTC — **läuft noch (Zahlen sind Zwischenstand)**.
...
- Optionen mit englischen Werten (Kandidaten): 3'382
- Optionen übersetzt: **1'815** · Werte übersetzt: **11'808**
- Optionen nur codebereinigt: 0
- Werte mit unbekanntem Wort (unverändert): 11'869
...
`light` 434, `inner` 368, `color` 306, `shell` 162, `degrees` 159, `core` 137, `surface` 124, `powder` 109, `no` 108, `diamond` 108, `high` 101, `skin` 98, `three` 97, `to` 96, `bag` 91, `rain` 88, `case` 87, `french` 84, `opp` 81, `belt` 79, `four` 78, `rope` 70, `base` 69, `dual` 69, `petal` 68, `chain` 67, `dark` 65, `feet` 62, `size` 62, `half` 62, `mother` 61, `of` 60, `code` 59, `tea` 58, `buckle` 58, `net` 57, `one` 55, `plush` 55, `electric` 54, `little` 54, `strap` 53, `face` 52, `line` 52, `person` 51, `fold` 51, `lens` 50, `bear` 49, `ice` 48, `suit` 48, `space` 48, `hat` 47, `cloud` 47, `cat` 46, `sheet` 46, `for` 46, `about` 46, `warped` 46, `night` 45, `milk` 45, `star` 45
