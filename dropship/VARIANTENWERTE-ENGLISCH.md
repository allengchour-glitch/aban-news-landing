...
> Werkzeug: `automation/variant_value_clean.py` (täglich im Aufseher). Durchgang seit 2026-09-23 20:46 UTC, Stand 2026-09-24 00:21 UTC — **läuft noch (Zahlen sind Zwischenstand)**.
...
- Werte mit unbekanntem Wort (unverändert): 5'048
...
`light` 196, `⟨satzbau:adjektiv-vor-nomen⟩` 163, `degrees` 159, `color` 127, `shell` 77, `skin` 72, `feet` 62, `rope` 61, `mother` 61, `core` 53, `to` 52, `surface` 49, `hat` 47, `high` 44, `case` 43, `for` 43, `dark` 41, `powder` 40, `years` 40, `acupuncture` 40, `lens` 38, `father` 38, `opp` 38, `generation` 37, `magnetic` 36, `no` 35, `old` 35, `bag` 34, `size` 33, `tea` 30, `bear` 30, `eyelets` 30, `adjustable` 29, `belt` 28, `carbon` 28, `mom` 28, `mushroom` 27, `suit` 27, `⟨satzbau:material-vor-farbe⟩` 26, `insert` 26, `⟨satzbau:nomen-vor-farbe⟩` 26, `crotch` 26, `flame` 25, `dog` 25, `cocoa` 25, `stone` 24, `milk` 24, `nail` 24, `regular` 24, `batteries` 24, `⟨satzbau:adjektivfolge⟩` 24, `dad` 24, `perforated` 24, `button` 24, `face` 23, `one` 23, `of` 23, `ring` 23, `electric` 22, `three` 22
