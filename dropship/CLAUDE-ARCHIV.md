# CLAUDE-ARCHIV — Historische Stand-Einträge (ausgelagert aus CLAUDE.md am 2026-06-23)

> Aktueller Stand: `SHARED-MEMORY.md` (Teil 27–64) + `dropship/AUTONOMER-MODUS.md` (Runbook). Dies ist nur Historie ≤2026-06-14.
