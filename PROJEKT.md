...
## 🧰 2026-06-20 — 33 neue Gratis-Tools (Traffic→Newsletter, „voll gas loop")
...
- **Neu gebaut & live (alle mit WebApplication+FAQPage-Schema, in online-tools + sitemap, Brain 100/100):**
  ...
  margen-rechner (Marge↔Aufschlag, Preis aus Wunsch-Marge/-Aufschlag) + rechnung-teilen (Betrag/Personen + Trinkgeld, Aufrunden) [batch-16].
