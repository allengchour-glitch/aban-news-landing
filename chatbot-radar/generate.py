#!/usr/bin/env python3
"""Chatbot-Radar — static site generator (German, DACH-Fokus).

Reads the curated AI-customer-service/chatbot-tool database (data/anbieter.json)
...
du-Form — KI-Kundenservice ist hype-lastig, hier wird ehrlich verglichen.
...
SITE_NAME = "Chatbot-Radar"
BASE_URL = "https://chatbot.abannews.com"
LANG = "de"
...
UI = {
    "tagline": "KI-Kundenservice- & Chatbot-Tools, ehrlich verglichen — für den DACH-Raum",
    "all_tools": "← Alle Tools",
    "categories": "Kategorien",
    "focuses": "Schwerpunkt",
    "home_heading": "{n} KI-Kundenservice- & Chatbot-Tools im Überblick",
    "provider": "Anbieter",
    "type": "Typ",
    "focus": "Schwerpunkt",
    "language": "Sprache",
    ...
    "best_in": "Beste Chatbot-Tools: {cat}",
    "focus_page": "Chatbot-Tools: {foc}",
    "privacy": "Datenschutz",
    "imprint": "Impressum",
    ...
    "honest": ("Ehrlich vorab: Ein Chatbot ersetzt keinen guten Kundenservice — er entlastet ihn. "
               "Inhalt der Wissensdatenbank, saubere Eskalation an Menschen und ehrliche Antworten "
               "liegen bei dir. Rechtspflichten (Transparenz „Du sprichst mit einem Bot“, "
...
FAVICON_SVG = (
    ...
    '<path d="M14 16h36a4 4 0 0 1 4 4v20a4 4 0 0 1-4 4H28l-12 10v-10h-2a4 4 0 0 1-4-4V20a4 4 0 0 1 4-4z" '
    ...
    '<circle cx="40" cy="30" r="2.6" fill="#fff"/></svg>'
)
...
def faq_section(tool):
    ...
    qa.append((f"Hostet {name} in der EU (DSGVO-relevant)?",
               {"ja": "Ja, laut Anbieter gibt es EU-Hosting bzw. EU-Datenverarbeitung — das erleichtert die DSGVO-Konformität. AVV (Auftragsverarbeitung) trotzdem prüfen.",
                ...
                "—": "Teilweise/abhängig vom Tarif — vor dem Start beim Anbieter und in dessen AVV prüfen."}[bool_str(tool.get("eu_lager"))]))
    # Integrationen
...
LEGAL_DOMAIN = "chatbot.abannews.com"
...
beim Einsatz von Chatbots im Kundenservice (z. B. Transparenz „Du sprichst mit einem Bot“,
Datenschutz-Hinweise, Auftragsverarbeitung nach Art. 28 DSGVO, ggf. Drittlandtransfer) liegen
beim Betreiber.</p>
...
def notfound_page():
    body = (f'<h1>💬 404 — Seite nicht gefunden</h1>\n'
            f'<p class="meta">Diese Seite gibt es nicht. Zurück zur Übersicht aller KI-Kundenservice- & Chatbot-Tools.</p>\n'
...
SEARCH_JS = """// Chatbot-Radar — client-side filter (no deps, no tracking)
(function () {
...
def main():
    ...
    ap = argparse.ArgumentParser(description="Chatbot-Radar generator")
