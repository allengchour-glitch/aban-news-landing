...
FAELLE = [
    ...
    ('<meta content="aban news: kurz, ehrlich, kein Buzzword-Bingo. Gratis.">', 1,
     '<meta content="aban news: kurz, ehrlich. Gratis.">',
     'die zweite Floskel-Familie haengt genauso hinten dran'),
    ('<meta content="Newsletter für DACH-Profis — 3–5 Minuten, kein Hype.">', 1,
     '<meta content="Newsletter für DACH-Profis — 3–5 Minuten.">',
     'kein Hype am Satzende ebenso'),
    ('<h2>Mehr Tiefe, kein Hype.</h2>', 0, None,
     'in der Ueberschrift ist auch kein Hype eine Aussage'),
    ('<a href="/bingo.html">Buzzword-Bingo fürs Meeting</a>', 0, None,
     "eine Seite, die WIRKLICH Buzzword-Bingo heisst, bleibt unberührt"),
    ('<p>Mo bis Fr morgens, 3-5 Minuten, kein Hype. 1-Klick raus.</p>', 1,
     '<p>Mo bis Fr morgens, 3-5 Minuten. 1-Klick raus.</p>',
     'die Zahlenspanne 3-5 ueberlebt (erster Entwurf machte daraus: 3.)'),
