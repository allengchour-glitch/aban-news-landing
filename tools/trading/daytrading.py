...
Gegenprobe: wer den Tagesschluss schon kennt, muss ~100 % treffen; Zufall ~50 %.
    ...
    python3 tools/trading/daytrading.py           # Bericht nach reports/DAYTRADING.md
    python3 tools/trading/daytrading.py --offline
"""
...
BERICHT = ROOT / "reports" / "DAYTRADING.md"
...
def bericht(z):
    L = ["# Daytrading-Test — ehrlicher Rückblick", "",
         f"Stand {date.today().isoformat()} · `python3 tools/trading/daytrading.py` · kein echtes Geld.", "",
